 ...
 */
public class ProductCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT101.ProductCodeDocument
{
    ...
    public stockFilePT101.SAFPTtextTypeMandatoryMax60Car xgetProductCode()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT101.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(PRODUCTCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetProductCode(stockFilePT101.SAFPTtextTypeMandatoryMax60Car productCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT101.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(PRODUCTCODE$0);
            }
