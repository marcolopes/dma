 ...
 */
public class ProductNumberCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT101.ProductNumberCodeDocument
{
    ...
    public stockFilePT101.SAFPTtextTypeMandatoryMax60Car xgetProductNumberCode()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT101.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(PRODUCTNUMBERCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetProductNumberCode(stockFilePT101.SAFPTtextTypeMandatoryMax60Car productNumberCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT101.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(PRODUCTNUMBERCODE$0);
            }
