 ...
 */
public class UnitOfMeasureDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT101.UnitOfMeasureDocument
{
    ...
    public stockFilePT101.SAFPTtextTypeMandatoryMax20Car xgetUnitOfMeasure()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT101.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(UNITOFMEASURE$0, 0);
            return target;
        }
    }
    ...
    public void xsetUnitOfMeasure(stockFilePT101.SAFPTtextTypeMandatoryMax20Car unitOfMeasure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT101.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(UNITOFMEASURE$0);
            }
