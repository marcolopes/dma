 ...
 */
public class WorkDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.WorkDateDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetWorkDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(WORKDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetWorkDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType workDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(WORKDATE$0);
            }
            target.set(workDate);
        }
    }
