 ...
 */
public class HashDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.HashDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax172Car xgetHash()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax172Car)get_store().find_element_user(HASH$0, 0);
            return target;
        }
    }
    ...
    public void xsetHash(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax172Car hash)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax172Car)get_store().add_element_user(HASH$0);
            }
            target.set(hash);
        }
    }
