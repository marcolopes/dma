 ...
 */
public class MovementTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument.MovementType xgetMovementType()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument.MovementType)get_store().find_element_user(MOVEMENTTYPE$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementType(x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument.MovementType movementType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument.MovementType)get_store().add_element_user(MOVEMENTTYPE$0);
            }
     ...
     */
    public static class MovementTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0401.oecdStandardAuditFileTaxPT1.MovementTypeDocument.MovementType
    {
        private static final long serialVersionUID = 1L;
