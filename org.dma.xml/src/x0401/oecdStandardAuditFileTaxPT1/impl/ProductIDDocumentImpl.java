 ...
 */
public class ProductIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.ProductIDDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTProductID xgetProductID()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTProductID)get_store().find_element_user(PRODUCTID$0, 0);
            return target;
        }
    }
    ...
    public void xsetProductID(x0401.oecdStandardAuditFileTaxPT1.SAFPTProductID productID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTProductID)get_store().add_element_user(PRODUCTID$0);
            }
