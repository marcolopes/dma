 ...
 */
public class PaymentMethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.PaymentMethod
{
    ...
    private static final javax.xml.namespace.QName PAYMENTAMOUNT$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "PaymentAmount");
    private static final javax.xml.namespace.QName PAYMENTDATE$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "PaymentDate");
    ...
    public boolean isSetPaymentMechanism()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PAYMENTMECHANISM$0) != 0;
        }
    }
    ...
    public void unsetPaymentMechanism()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PAYMENTMECHANISM$0, 0);
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetPaymentAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(PAYMENTAMOUNT$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPaymentAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType paymentAmount)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(PAYMENTAMOUNT$2);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetPaymentDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(PAYMENTDATE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPaymentDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType paymentDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(PAYMENTDATE$4);
            }
