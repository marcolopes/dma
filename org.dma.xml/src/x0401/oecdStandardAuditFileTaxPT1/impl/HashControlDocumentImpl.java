 ...
 */
public class HashControlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.HashControlDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTHashControl xgetHashControl()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTHashControl)get_store().find_element_user(HASHCONTROL$0, 0);
            return target;
        }
    }
    ...
    public void xsetHashControl(x0401.oecdStandardAuditFileTaxPT1.SAFPTHashControl hashControl)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTHashControl)get_store().add_element_user(HASHCONTROL$0);
            }
