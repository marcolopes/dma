 ...
 */
public class ShippingPointStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.ShippingPointStructure
{
    ...
    private static final javax.xml.namespace.QName DELIVERYID$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "DeliveryID");
    private static final javax.xml.namespace.QName DELIVERYDATE$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "DeliveryDate");
    ...
    public java.lang.String[] getDeliveryIDArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car>();
     ...
     */
    public java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car> xgetDeliveryIDList()
    {
        final class DeliveryIDList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car>
        {
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car get(int i)
                { return ShippingPointStructureImpl.this.xgetDeliveryIDArray(i); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car set(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car o)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car old = ShippingPointStructureImpl.this.xgetDeliveryIDArray(i);
                ShippingPointStructureImpl.this.xsetDeliveryIDArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car o)
                { ShippingPointStructureImpl.this.insertNewDeliveryID(i).set(o); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car remove(int i)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car old = ShippingPointStructureImpl.this.xgetDeliveryIDArray(i);
                ShippingPointStructureImpl.this.removeDeliveryID(i);
                return old;
     ...
     */
    @Deprecated
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car[] xgetDeliveryIDArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car>();
            get_store().find_all_element_users(DELIVERYID$0, targetList);
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car[] result = new x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car[targetList.size()];
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car xgetDeliveryIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().find_element_user(DELIVERYID$0, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void xsetDeliveryIDArray(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car[]deliveryIDArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetDeliveryIDArray(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car deliveryID)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car insertNewDeliveryID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().insert_element_user(DELIVERYID$0, i);
            return target;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car addNewDeliveryID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().add_element_user(DELIVERYID$0);
            return target;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetDeliveryDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(DELIVERYDATE$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetDeliveryDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType deliveryDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(DELIVERYDATE$2);
            }
    ...
    public java.lang.String[] getWarehouseIDArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car>();
     ...
     */
    public java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car> xgetWarehouseIDList()
    {
        final class WarehouseIDList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car>
        {
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car get(int i)
                { return ShippingPointStructureImpl.this.xgetWarehouseIDArray(i); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car set(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car o)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car old = ShippingPointStructureImpl.this.xgetWarehouseIDArray(i);
                ShippingPointStructureImpl.this.xsetWarehouseIDArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car o)
                { ShippingPointStructureImpl.this.insertNewWarehouseID(i).set(o); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car remove(int i)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car old = ShippingPointStructureImpl.this.xgetWarehouseIDArray(i);
                ShippingPointStructureImpl.this.removeWarehouseID(i);
                return old;
     ...
     */
    @Deprecated
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car[] xgetWarehouseIDArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car>();
            get_store().find_all_element_users(WAREHOUSEID$4, targetList);
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car[] result = new x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetWarehouseIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(WAREHOUSEID$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void xsetWarehouseIDArray(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car[]warehouseIDArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetWarehouseIDArray(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car warehouseID)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car insertNewWarehouseID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().insert_element_user(WAREHOUSEID$4, i);
            return target;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car addNewWarehouseID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(WAREHOUSEID$4);
            return target;
        }
    }
    ...
    public java.lang.String[] getLocationIDArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car>();
     ...
     */
    public java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car> xgetLocationIDList()
    {
        final class LocationIDList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car>
        {
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car get(int i)
                { return ShippingPointStructureImpl.this.xgetLocationIDArray(i); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car set(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car o)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car old = ShippingPointStructureImpl.this.xgetLocationIDArray(i);
                ShippingPointStructureImpl.this.xsetLocationIDArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car o)
                { ShippingPointStructureImpl.this.insertNewLocationID(i).set(o); }
            
            @Override
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car remove(int i)
            {
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car old = ShippingPointStructureImpl.this.xgetLocationIDArray(i);
                ShippingPointStructureImpl.this.removeLocationID(i);
                return old;
     ...
     */
    @Deprecated
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car[] xgetLocationIDArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car>();
            get_store().find_all_element_users(LOCATIONID$6, targetList);
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car[] result = new x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetLocationIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(LOCATIONID$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void xsetLocationIDArray(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car[]locationIDArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetLocationIDArray(int i, x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car locationID)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car insertNewLocationID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().insert_element_user(LOCATIONID$6, i);
            return target;
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car addNewLocationID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(LOCATIONID$6);
            return target;
        }
    }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.AddressStructure getAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(ADDRESS$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.AddressStructure addNewAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(ADDRESS$8);
            return target;
        }
    }
