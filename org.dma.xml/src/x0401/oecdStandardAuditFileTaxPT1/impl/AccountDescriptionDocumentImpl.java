 ...
 */
public class AccountDescriptionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.AccountDescriptionDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car xgetAccountDescription()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().find_element_user(ACCOUNTDESCRIPTION$0, 0);
            return target;
        }
    }
    ...
    public void xsetAccountDescription(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car accountDescription)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().add_element_user(ACCOUNTDESCRIPTION$0);
            }
