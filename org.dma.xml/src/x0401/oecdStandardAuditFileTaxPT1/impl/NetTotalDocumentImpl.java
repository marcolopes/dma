 ...
 */
public class NetTotalDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.NetTotalDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetNetTotal()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(NETTOTAL$0, 0);
            return target;
        }
    }
    ...
    public void xsetNetTotal(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType netTotal)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(NETTOTAL$0);
            }
            target.set(netTotal);
        }
    }
