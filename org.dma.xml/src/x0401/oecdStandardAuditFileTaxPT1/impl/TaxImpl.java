 ...
 */
public class TaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.Tax
{
    private static final long serialVersionUID = 1L;
    
    public TaxImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode xgetTaxCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().find_element_user(TAXCODE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTaxCode(x0401.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode taxCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().add_element_user(TAXCODE$4);
            }
            target.set(taxCode);
        }
    }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$6, 0);
            return target;
        }
    }
    ...
    public void xsetTaxPercentage(x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$6);
            }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$8, 0);
            return target;
        }
    }
    ...
    public void xsetTaxAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$8);
            }
