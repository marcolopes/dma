 ...
 */
public class InvoiceStatusDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.InvoiceStatusDateDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetInvoiceStatusDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(INVOICESTATUSDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetInvoiceStatusDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType invoiceStatusDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(INVOICESTATUSDATE$0);
            }
