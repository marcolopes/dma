 ...
 */
public class OrderReferencesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.OrderReferences
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetOrderDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(ORDERDATE$2, 0);
            return target;
        }
    }
    ...
    public void xsetOrderDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType orderDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(ORDERDATE$2);
            }
