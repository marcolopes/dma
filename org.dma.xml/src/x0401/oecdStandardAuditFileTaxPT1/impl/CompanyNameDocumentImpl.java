 ...
 */
public class CompanyNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.CompanyNameDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car xgetCompanyName()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().find_element_user(COMPANYNAME$0, 0);
            return target;
        }
    }
    ...
    public void xsetCompanyName(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car companyName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().add_element_user(COMPANYNAME$0);
            }
