 ...
 */
public class MovementTaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.MovementTax
{
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType.Enum getTaxType()
    {
        synchronized (monitor())
        {
            ...
            return (x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType xgetTaxType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType)get_store().find_element_user(TAXTYPE$0, 0);
            return target;
        }
    }
     ...
     */
    public void setTaxType(x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType.Enum taxType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTaxType(x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType taxType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxType)get_store().add_element_user(TAXTYPE$0);
            }
            target.set(taxType);
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxCode xgetTaxCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxCode target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxCode)get_store().find_element_user(TAXCODE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTaxCode(x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxCode taxCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTMovementTaxCode)get_store().add_element_user(TAXCODE$4);
            }
            target.set(taxCode);
        }
    }
