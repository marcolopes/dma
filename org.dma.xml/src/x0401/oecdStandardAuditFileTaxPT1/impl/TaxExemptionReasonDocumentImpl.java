 ...
 */
public class TaxExemptionReasonDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.TaxExemptionReasonDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemptionReason xgetTaxExemptionReason()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemptionReason)get_store().find_element_user(TAXEXEMPTIONREASON$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxExemptionReason(x0401.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemptionReason taxExemptionReason)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemptionReason)get_store().add_element_user(TAXEXEMPTIONREASON$0);
            }
