 ...
 */
public class GroupingCategoryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory xgetGroupingCategory()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory)get_store().find_element_user(GROUPINGCATEGORY$0, 0);
            return target;
        }
    }
    ...
    public void xsetGroupingCategory(x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory groupingCategory)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory)get_store().add_element_user(GROUPINGCATEGORY$0);
            }
     ...
     */
    public static class GroupingCategoryImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0401.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory
    {
        private static final long serialVersionUID = 1L;
