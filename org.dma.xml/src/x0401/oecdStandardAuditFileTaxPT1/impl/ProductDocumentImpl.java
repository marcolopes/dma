 ...
 */
public class ProductDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.ProductDocument
{
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product getProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product)get_store().find_element_user(PRODUCT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setProduct(x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product product)
    {
    ...
    public x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product addNewProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product)get_store().add_element_user(PRODUCT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ProductImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.ProductDocument.Product
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName PRODUCTTYPE$0 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "ProductType");
        ...
        private static final javax.xml.namespace.QName PRODUCTGROUP$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "ProductGroup");
        ...
        private static final javax.xml.namespace.QName CUSTOMSDETAILS$10 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "CustomsDetails");
        
        
        /**
         * Gets the "ProductType" element
         */
        public x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum getProductType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType xgetProductType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType)get_store().find_element_user(PRODUCTTYPE$0, 0);
                return target;
            }
        }
         ...
         */
        public void setProductType(x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum productType)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetProductType(x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType productType)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType)get_store().add_element_user(PRODUCTTYPE$0);
                }
        ...
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetProductCode()
        {
            synchronized (monitor())
            {
                ...
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(PRODUCTCODE$2, 0);
                return target;
            }
        }
        ...
        public void xsetProductCode(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car productCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(PRODUCTCODE$2);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetProductGroup()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(PRODUCTGROUP$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetProductGroup(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car productGroup)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(PRODUCTGROUP$4);
                }
        ...
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetProductNumberCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(PRODUCTNUMBERCODE$8, 0);
                return target;
            }
        }
        ...
        public void xsetProductNumberCode(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car productNumberCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(PRODUCTNUMBERCODE$8);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.CustomsDetails getCustomsDetails()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.CustomsDetails target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.CustomsDetails)get_store().find_element_user(CUSTOMSDETAILS$10, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public boolean isSetCustomsDetails()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().count_elements(CUSTOMSDETAILS$10) != 0;
            }
        }
         ...
         */
        public void setCustomsDetails(x0401.oecdStandardAuditFileTaxPT1.CustomsDetails customsDetails)
        {
            generatedSetterHelperImpl(customsDetails, CUSTOMSDETAILS$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
        }
        
        /**
         * Appends and returns a new empty "CustomsDetails" element
         */
        public x0401.oecdStandardAuditFileTaxPT1.CustomsDetails addNewCustomsDetails()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.CustomsDetails target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.CustomsDetails)get_store().add_element_user(CUSTOMSDETAILS$10);
                return target;
            }
        }
         ...
         */
        public void unsetCustomsDetails()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(CUSTOMSDETAILS$10, 0);
            }
        }
    }
}
