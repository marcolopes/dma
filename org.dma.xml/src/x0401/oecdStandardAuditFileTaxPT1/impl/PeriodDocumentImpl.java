 ...
 */
public class PeriodDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.PeriodDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.PeriodDocument.Period xgetPeriod()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.PeriodDocument.Period)get_store().find_element_user(PERIOD$0, 0);
            return target;
        }
    }
    ...
    public void xsetPeriod(x0401.oecdStandardAuditFileTaxPT1.PeriodDocument.Period period)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.PeriodDocument.Period)get_store().add_element_user(PERIOD$0);
            }
            target.set(period);
        }
    }
     ...
     */
    public static class PeriodImpl extends org.apache.xmlbeans.impl.values.JavaIntHolderEx implements x0401.oecdStandardAuditFileTaxPT1.PeriodDocument.Period
    {
        private static final long serialVersionUID = 1L;
