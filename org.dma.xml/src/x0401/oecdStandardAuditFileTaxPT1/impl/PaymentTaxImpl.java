 ...
 */
public class PaymentTaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.PaymentTax
{
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.PaymentTaxCode xgetTaxCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.PaymentTaxCode target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.PaymentTaxCode)get_store().find_element_user(TAXCODE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTaxCode(x0401.oecdStandardAuditFileTaxPT1.PaymentTaxCode taxCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.PaymentTaxCode)get_store().add_element_user(TAXCODE$4);
            }
            target.set(taxCode);
        }
    }
