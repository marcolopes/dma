 ...
 */
public class WithholdingTaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.WithholdingTax
{
    ...
    private static final javax.xml.namespace.QName WITHHOLDINGTAXTYPE$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "WithholdingTaxType");
    private static final javax.xml.namespace.QName WITHHOLDINGTAXDESCRIPTION$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "WithholdingTaxDescription");
    private static final javax.xml.namespace.QName WITHHOLDINGTAXAMOUNT$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "WithholdingTaxAmount");
    
    
    /**
     * Gets the "WithholdingTaxType" element
     */
    public x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType.Enum getWithholdingTaxType()
    {
        synchronized (monitor())
        {
            ...
            return (x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType xgetWithholdingTaxType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType)get_store().find_element_user(WITHHOLDINGTAXTYPE$0, 0);
            return target;
        }
    }
     ...
     */
    public void setWithholdingTaxType(x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType.Enum withholdingTaxType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetWithholdingTaxType(x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType withholdingTaxType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.WithholdingTaxTypeDocument.WithholdingTaxType)get_store().add_element_user(WITHHOLDINGTAXTYPE$0);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetWithholdingTaxDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(WITHHOLDINGTAXDESCRIPTION$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetWithholdingTaxDescription(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car withholdingTaxDescription)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(WITHHOLDINGTAXDESCRIPTION$2);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetWithholdingTaxAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(WITHHOLDINGTAXAMOUNT$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetWithholdingTaxAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType withholdingTaxAmount)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(WITHHOLDINGTAXAMOUNT$4);
            }
