 ...
 */
public class StartDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.StartDateDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTDateSpan xgetStartDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().find_element_user(STARTDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetStartDate(x0401.oecdStandardAuditFileTaxPT1.SAFPTDateSpan startDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().add_element_user(STARTDATE$0);
            }
