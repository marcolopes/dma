 ...
 */
public class GeneralLedgerEntriesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries getGeneralLedgerEntries()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries)get_store().find_element_user(GENERALLEDGERENTRIES$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries addNewGeneralLedgerEntries()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries)get_store().add_element_user(GENERALLEDGERENTRIES$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class GeneralLedgerEntriesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName JOURNAL$6 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "Journal");
         ...
         */
        public java.util.List<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal> getJournalList()
        {
            final class JournalList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal>
            {
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal get(int i)
                    { return GeneralLedgerEntriesImpl.this.getJournalArray(i); }
                
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal set(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal o)
                {
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal old = GeneralLedgerEntriesImpl.this.getJournalArray(i);
                    GeneralLedgerEntriesImpl.this.setJournalArray(i, o);
                    return old;
                }
                
                @Override
                public void add(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal o)
                    { GeneralLedgerEntriesImpl.this.insertNewJournal(i).set(o); }
                
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal remove(int i)
                {
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal old = GeneralLedgerEntriesImpl.this.getJournalArray(i);
         ...
         */
        @Deprecated
        public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] getJournalArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                java.util.List<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal>();
                get_store().find_all_element_users(JOURNAL$6, targetList);
                x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] result = new x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[targetList.size()];
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal getJournalArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().find_element_user(JOURNAL$6, i);
                if (target == null)
                {
         ...
         */
        public void setJournalArray(x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] journalArray)
        {
            check_orphaned();
         ...
         */
        public void setJournalArray(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal journal)
        {
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal insertNewJournal(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().insert_element_user(JOURNAL$6, i);
                return target;
            }
        }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal addNewJournal()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().add_element_user(JOURNAL$6);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class JournalImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal
        {
            private static final long serialVersionUID = 1L;
            ...
            private static final javax.xml.namespace.QName TRANSACTION$4 = 
                new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "Transaction");
            ...
            public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car xgetDescription()
            {
                synchronized (monitor())
                {
                    ...
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().find_element_user(DESCRIPTION$2, 0);
                    return target;
                }
            }
            ...
            public void xsetDescription(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car description)
            {
                synchronized (monitor())
                {
                    ...
                    if (target == null)
                    {
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().add_element_user(DESCRIPTION$2);
                    }
             ...
             */
            public java.util.List<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction> getTransactionList()
            {
                final class TransactionList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction>
                {
                    @Override
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction get(int i)
                        { return JournalImpl.this.getTransactionArray(i); }
                    
                    @Override
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction set(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction o)
                    {
                      x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction old = JournalImpl.this.getTransactionArray(i);
                      JournalImpl.this.setTransactionArray(i, o);
                      return old;
                    }
                    
                    @Override
                    public void add(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction o)
                        { JournalImpl.this.insertNewTransaction(i).set(o); }
                    
                    @Override
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction remove(int i)
                    {
                      x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction old = JournalImpl.this.getTransactionArray(i);
             ...
             */
            @Deprecated
            public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] getTransactionArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    java.util.List<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction>();
                    get_store().find_all_element_users(TRANSACTION$4, targetList);
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] result = new x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction getTransactionArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().find_element_user(TRANSACTION$4, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setTransactionArray(x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] transactionArray)
            {
                check_orphaned();
             ...
             */
            public void setTransactionArray(int i, x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction transaction)
            {
             ...
             */
            public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction insertNewTransaction(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().insert_element_user(TRANSACTION$4, i);
                    return target;
                }
            }
             ...
             */
            public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction addNewTransaction()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().add_element_user(TRANSACTION$4);
                    return target;
                }
            }
             ...
             * This is a complex type.
             */
            public static class TransactionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction
            {
                private static final long serialVersionUID = 1L;
                ...
                private static final javax.xml.namespace.QName DOCARCHIVALNUMBER$10 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "DocArchivalNumber");
                private static final javax.xml.namespace.QName TRANSACTIONTYPE$12 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TransactionType");
                private static final javax.xml.namespace.QName GLPOSTINGDATE$14 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "GLPostingDate");
                ...
                private static final javax.xml.namespace.QName LINES$20 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "Lines");
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod xgetPeriod()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod)get_store().find_element_user(PERIOD$2, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void xsetPeriod(x0401.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod period)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod)get_store().add_element_user(PERIOD$2);
                      }
                      target.set(period);
                    }
                }
                ...
                public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetTransactionDate()
                {
                    synchronized (monitor())
                    {
                      ...
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TRANSACTIONDATE$4, 0);
                      return target;
                    }
                }
                ...
                public void xsetTransactionDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType transactionDate)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TRANSACTIONDATE$4);
                      }
                ...
                public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car xgetDescription()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().find_element_user(DESCRIPTION$8, 0);
                      return target;
                    }
                }
                ...
                public void xsetDescription(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car description)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().add_element_user(DESCRIPTION$8);
                      }
                      target.set(description);
                    }
                }
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber xgetDocArchivalNumber()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().find_element_user(DOCARCHIVALNUMBER$10, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void xsetDocArchivalNumber(x0401.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber docArchivalNumber)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().add_element_user(DOCARCHIVALNUMBER$10);
                      }
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType.Enum getTransactionType()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      return (x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType.Enum)target.getEnumValue();
                    }
                }
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType xgetTransactionType()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().find_element_user(TRANSACTIONTYPE$12, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void setTransactionType(x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType.Enum transactionType)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                 ...
                 */
                public void xsetTransactionType(x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType transactionType)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().add_element_user(TRANSACTIONTYPE$12);
                      }
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetGLPostingDate()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(GLPOSTINGDATE$14, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void xsetGLPostingDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType glPostingDate)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(GLPOSTINGDATE$14);
                      }
                ...
                public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetCustomerID()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(CUSTOMERID$16, 0);
                      return target;
                    }
                }
                ...
                public void xsetCustomerID(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car customerID)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(CUSTOMERID$16);
                      }
                ...
                public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSupplierID()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SUPPLIERID$18, 0);
                      return target;
                    }
                }
                ...
                public void xsetSupplierID(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car supplierID)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SUPPLIERID$18);
                      }
                 ...
                 */
                public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines getLines()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines)get_store().find_element_user(LINES$20, 0);
                      if (target == null)
                      {
                        return null;
                      }
                 ...
                 */
                public void setLines(x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines lines)
                {
                    generatedSetterHelperImpl(lines, LINES$20, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
                }
                
                /**
                 * Appends and returns a new empty "Lines" element
                 */
                public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines addNewLines()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines target = null;
                      target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines)get_store().add_element_user(LINES$20);
                      return target;
                    }
                }
                /**
                 ...
                 * This is a complex type.
                 */
                public static class LinesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines
                {
                    private static final long serialVersionUID = 1L;
                    ...
                    private static final javax.xml.namespace.QName DEBITLINE$0 = 
                      new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "DebitLine");
                    private static final javax.xml.namespace.QName CREDITLINE$2 = 
                      new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "CreditLine");
                    
                    
                    /**
                     * Gets the "DebitLine" element
                     */
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine getDebitLine()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine target = null;
                        target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine)get_store().find_element_user(DEBITLINE$0, 0);
                        if (target == null)
                        {
                          return null;
                        }
                     ...
                     */
                    public void setDebitLine(x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine debitLine)
                    {
                      generatedSetterHelperImpl(debitLine, DEBITLINE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
                    }
                    
                    /**
                     * Appends and returns a new empty "DebitLine" element
                     */
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine addNewDebitLine()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine target = null;
                        target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine)get_store().add_element_user(DEBITLINE$0);
                        return target;
                      }
                    }
                     ...
                     */
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine getCreditLine()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine target = null;
                        target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine)get_store().find_element_user(CREDITLINE$2, 0);
                        if (target == null)
                        {
                          return null;
                        }
                     ...
                     */
                    public void setCreditLine(x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine creditLine)
                    {
                      generatedSetterHelperImpl(creditLine, CREDITLINE$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
                    }
                    
                    /**
                     * Appends and returns a new empty "CreditLine" element
                     */
                    public x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine addNewCreditLine()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine target = null;
                        target = (x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine)get_store().add_element_user(CREDITLINE$2);
                        return target;
                      }
                    }
                    /**
                     ...
                     * This is a complex type.
                     */
                    public static class DebitLineImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.DebitLine
                    {
                      private static final long serialVersionUID = 1L;
                      
                      public DebitLineImpl(org.apache.xmlbeans.SchemaType sType)
                      {
                        super(sType);
                      }
                      ...
                      public x0401.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID xgetAccountID()
                      {
                        synchronized (monitor())
                        {
                          ...
                          target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().find_element_user(ACCOUNTID$2, 0);
                          return target;
                        }
                      }
                      ...
                      public void xsetAccountID(x0401.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID accountID)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().add_element_user(ACCOUNTID$2);
                          }
                      ...
                      public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetSourceDocumentID()
                      {
                        synchronized (monitor())
                        {
                          ...
                          target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(SOURCEDOCUMENTID$4, 0);
                          return target;
                        }
                      }
                      ...
                      public void xsetSourceDocumentID(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car sourceDocumentID)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(SOURCEDOCUMENTID$4);
                          }
                      ...
                      public x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetSystemEntryDate()
                      {
                        synchronized (monitor())
                        {
                          ...
                          target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(SYSTEMENTRYDATE$6, 0);
                          return target;
                        }
                      }
                      ...
                      public void xsetSystemEntryDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType systemEntryDate)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(SYSTEMENTRYDATE$6);
                          }
                      ...
                      public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetDebitAmount()
                      {
                        synchronized (monitor())
                        {
                          check_orphaned();
                          x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                          target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(DEBITAMOUNT$10, 0);
                          return target;
                        }
                      }
                      ...
                      public void xsetDebitAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType debitAmount)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(DEBITAMOUNT$10);
                          }
                     ...
                     * This is a complex type.
                     */
                    public static class CreditLineImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Lines.CreditLine
                    {
                      private static final long serialVersionUID = 1L;
                      
                      public CreditLineImpl(org.apache.xmlbeans.SchemaType sType)
                      {
                        super(sType);
                      }
                      ...
                      private static final javax.xml.namespace.QName DESCRIPTION$8 = 
                        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "Description");
                      private static final javax.xml.namespace.QName CREDITAMOUNT$10 = 
                      ...
                      public java.math.BigDecimal getCreditAmount()
                      {
                        synchronized (monitor())
                        {
                          check_orphaned();
                          org.apache.xmlbeans.SimpleValue target = null;
                          target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(CREDITAMOUNT$10, 0);
                          if (target == null)
                          {
                            return null;
                          }
                      ...
                      public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetCreditAmount()
                      {
                        synchronized (monitor())
                        {
                          check_orphaned();
                          x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                          target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CREDITAMOUNT$10, 0);
                          return target;
                        }
                      }
                      ...
                      public void setCreditAmount(java.math.BigDecimal creditAmount)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(CREDITAMOUNT$10);
                          }
                      ...
                      public void xsetCreditAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType creditAmount)
                      {
                        synchronized (monitor())
                        {
                          ...
                          if (target == null)
                          {
                            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CREDITAMOUNT$10);
                          }
