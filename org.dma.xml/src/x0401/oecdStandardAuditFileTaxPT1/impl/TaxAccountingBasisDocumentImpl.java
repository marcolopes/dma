 ...
 */
public class TaxAccountingBasisDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument.TaxAccountingBasis xgetTaxAccountingBasis()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument.TaxAccountingBasis)get_store().find_element_user(TAXACCOUNTINGBASIS$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxAccountingBasis(x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument.TaxAccountingBasis taxAccountingBasis)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument.TaxAccountingBasis)get_store().add_element_user(TAXACCOUNTINGBASIS$0);
            }
     ...
     */
    public static class TaxAccountingBasisImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0401.oecdStandardAuditFileTaxPT1.TaxAccountingBasisDocument.TaxAccountingBasis
    {
        private static final long serialVersionUID = 1L;
