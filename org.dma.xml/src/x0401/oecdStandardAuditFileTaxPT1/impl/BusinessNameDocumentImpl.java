 ...
 */
public class BusinessNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.BusinessNameDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetBusinessName()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(BUSINESSNAME$0, 0);
            return target;
        }
    }
    ...
    public void xsetBusinessName(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car businessName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(BUSINESSNAME$0);
            }
