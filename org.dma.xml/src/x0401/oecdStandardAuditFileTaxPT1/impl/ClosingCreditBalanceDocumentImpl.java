 ...
 */
public class ClosingCreditBalanceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.ClosingCreditBalanceDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetClosingCreditBalance()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CLOSINGCREDITBALANCE$0, 0);
            return target;
        }
    }
    ...
    public void xsetClosingCreditBalance(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType closingCreditBalance)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CLOSINGCREDITBALANCE$0);
            }
