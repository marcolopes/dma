 ...
 */
public class HeaderCommentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.HeaderCommentDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car xgetHeaderComment()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().find_element_user(HEADERCOMMENT$0, 0);
            return target;
        }
    }
    ...
    public void xsetHeaderComment(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car headerComment)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().add_element_user(HEADERCOMMENT$0);
            }
