 ...
 */
public class SupplierAddressStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.SupplierAddressStructure
{
    ...
    private static final javax.xml.namespace.QName BUILDINGNUMBER$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "BuildingNumber");
    ...
    private static final javax.xml.namespace.QName ADDRESSDETAIL$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "AddressDetail");
    private static final javax.xml.namespace.QName CITY$6 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "City");
    private static final javax.xml.namespace.QName POSTALCODE$8 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "PostalCode");
    private static final javax.xml.namespace.QName REGION$10 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "Region");
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car xgetBuildingNumber()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().find_element_user(BUILDINGNUMBER$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetBuildingNumber(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car buildingNumber)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().add_element_user(BUILDINGNUMBER$0);
            }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car xgetStreetName()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().find_element_user(STREETNAME$2, 0);
            return target;
        }
    }
    ...
    public void xsetStreetName(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car streetName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().add_element_user(STREETNAME$2);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax210Car xgetAddressDetail()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax210Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax210Car)get_store().find_element_user(ADDRESSDETAIL$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetAddressDetail(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax210Car addressDetail)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax210Car)get_store().add_element_user(ADDRESSDETAIL$4);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetCity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(CITY$6, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCity(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car city)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(CITY$6);
            }
            target.set(city);
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetPostalCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(POSTALCODE$8, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPostalCode(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car postalCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(POSTALCODE$8);
            }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetRegion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(REGION$10, 0);
            return target;
        }
    }
     ...
     */
    public void xsetRegion(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car region)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(REGION$10);
            }
            target.set(region);
        }
    }
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.SupplierCountry xgetCountry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.SupplierCountry target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.SupplierCountry)get_store().find_element_user(COUNTRY$12, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCountry(x0401.oecdStandardAuditFileTaxPT1.SupplierCountry country)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SupplierCountry)get_store().add_element_user(COUNTRY$12);
            }
            target.set(country);
        }
    }
