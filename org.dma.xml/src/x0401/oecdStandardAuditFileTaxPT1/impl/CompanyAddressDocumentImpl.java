 ...
 */
public class CompanyAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.CompanyAddressDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.AddressStructurePT getCompanyAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructurePT)get_store().find_element_user(COMPANYADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0401.oecdStandardAuditFileTaxPT1.AddressStructurePT addNewCompanyAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.AddressStructurePT target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructurePT)get_store().add_element_user(COMPANYADDRESS$0);
            return target;
        }
    }
}
