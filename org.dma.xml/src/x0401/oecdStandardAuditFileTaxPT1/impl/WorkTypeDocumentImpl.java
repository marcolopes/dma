 ...
 */
public class WorkTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument.WorkType xgetWorkType()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument.WorkType)get_store().find_element_user(WORKTYPE$0, 0);
            return target;
        }
    }
    ...
    public void xsetWorkType(x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument.WorkType workType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument.WorkType)get_store().add_element_user(WORKTYPE$0);
            }
            target.set(workType);
        }
    }
     ...
     */
    public static class WorkTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0401.oecdStandardAuditFileTaxPT1.WorkTypeDocument.WorkType
    {
        private static final long serialVersionUID = 1L;
