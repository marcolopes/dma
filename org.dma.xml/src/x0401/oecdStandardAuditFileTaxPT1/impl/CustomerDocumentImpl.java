 ...
 */
public class CustomerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.CustomerDocument
{
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer getCustomer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer)get_store().find_element_user(CUSTOMER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCustomer(x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer customer)
    {
    ...
    public x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer addNewCustomer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer)get_store().add_element_user(CUSTOMER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CustomerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName CUSTOMERTAXID$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "CustomerTaxID");
        ...
        private static final javax.xml.namespace.QName SHIPTOADDRESS$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "ShipToAddress");
        ...
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetCustomerID()
        {
            synchronized (monitor())
            {
                ...
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(CUSTOMERID$0, 0);
                return target;
            }
        }
        ...
        public void xsetCustomerID(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car customerID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(CUSTOMERID$0);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetCustomerTaxID()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(CUSTOMERTAXID$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetCustomerTaxID(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car customerTaxID)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(CUSTOMERTAXID$4);
                }
        ...
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure getBillingAddress()
        {
            synchronized (monitor())
            {
                ...
                target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(BILLINGADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure addNewBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(BILLINGADDRESS$10);
                return target;
            }
        }
         ...
         */
        public java.util.List<x0401.oecdStandardAuditFileTaxPT1.AddressStructure> getShipToAddressList()
        {
            final class ShipToAddressList extends java.util.AbstractList<x0401.oecdStandardAuditFileTaxPT1.AddressStructure>
            {
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.AddressStructure get(int i)
                    { return CustomerImpl.this.getShipToAddressArray(i); }
                
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.AddressStructure set(int i, x0401.oecdStandardAuditFileTaxPT1.AddressStructure o)
                {
                    x0401.oecdStandardAuditFileTaxPT1.AddressStructure old = CustomerImpl.this.getShipToAddressArray(i);
                    CustomerImpl.this.setShipToAddressArray(i, o);
                    return old;
                }
                
                @Override
                public void add(int i, x0401.oecdStandardAuditFileTaxPT1.AddressStructure o)
                    { CustomerImpl.this.insertNewShipToAddress(i).set(o); }
                
                @Override
                public x0401.oecdStandardAuditFileTaxPT1.AddressStructure remove(int i)
                {
                    x0401.oecdStandardAuditFileTaxPT1.AddressStructure old = CustomerImpl.this.getShipToAddressArray(i);
         ...
         */
        @Deprecated
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure[] getShipToAddressArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                java.util.List<x0401.oecdStandardAuditFileTaxPT1.AddressStructure> targetList = new java.util.ArrayList<x0401.oecdStandardAuditFileTaxPT1.AddressStructure>();
                get_store().find_all_element_users(SHIPTOADDRESS$12, targetList);
                x0401.oecdStandardAuditFileTaxPT1.AddressStructure[] result = new x0401.oecdStandardAuditFileTaxPT1.AddressStructure[targetList.size()];
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure getShipToAddressArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(SHIPTOADDRESS$12, i);
                if (target == null)
                {
         ...
         */
        public void setShipToAddressArray(x0401.oecdStandardAuditFileTaxPT1.AddressStructure[] shipToAddressArray)
        {
            check_orphaned();
         ...
         */
        public void setShipToAddressArray(int i, x0401.oecdStandardAuditFileTaxPT1.AddressStructure shipToAddress)
        {
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure insertNewShipToAddress(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().insert_element_user(SHIPTOADDRESS$12, i);
                return target;
            }
        }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.AddressStructure addNewShipToAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(SHIPTOADDRESS$12);
                return target;
            }
        }
