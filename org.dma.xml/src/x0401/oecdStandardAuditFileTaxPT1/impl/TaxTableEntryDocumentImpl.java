 ...
 */
public class TaxTableEntryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument
{
    ...
    private static final javax.xml.namespace.QName TAXTABLEENTRY$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxTableEntry");
    
    
    /**
     * Gets the "TaxTableEntry" element
     */
    public x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry getTaxTableEntry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry)get_store().find_element_user(TAXTABLEENTRY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTaxTableEntry(x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry taxTableEntry)
    {
     ...
     */
    public x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry addNewTaxTableEntry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry target = null;
            target = (x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry)get_store().add_element_user(TAXTABLEENTRY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TaxTableEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName TAXTYPE$0 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxType");
        ...
        private static final javax.xml.namespace.QName TAXCODE$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxCode");
        ...
        private static final javax.xml.namespace.QName TAXEXPIRATIONDATE$8 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxExpirationDate");
        private static final javax.xml.namespace.QName TAXPERCENTAGE$10 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxPercentage");
        private static final javax.xml.namespace.QName TAXAMOUNT$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.04_01", "TaxAmount");
        
        
        /**
         * Gets the "TaxType" element
         */
        public x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType.Enum getTaxType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType xgetTaxType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType)get_store().find_element_user(TAXTYPE$0, 0);
                return target;
            }
        }
         ...
         */
        public void setTaxType(x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType.Enum taxType)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetTaxType(x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType taxType)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.TaxTypeDocument.TaxType)get_store().add_element_user(TAXTYPE$0);
                }
                target.set(taxType);
            }
        }
        ...
        public x0401.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion xgetTaxCountryRegion()
        {
            synchronized (monitor())
            {
                ...
                target = (x0401.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion)get_store().find_element_user(TAXCOUNTRYREGION$2, 0);
                return target;
            }
        }
        ...
        public void xsetTaxCountryRegion(x0401.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion taxCountryRegion)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion)get_store().add_element_user(TAXCOUNTRYREGION$2);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode xgetTaxCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode)get_store().find_element_user(TAXCODE$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxCode(x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode taxCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode)get_store().add_element_user(TAXCODE$4);
                }
                target.set(taxCode);
            }
        }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car xgetDescription()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().find_element_user(DESCRIPTION$6, 0);
                return target;
            }
        }
         ...
         */
        public void xsetDescription(x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car description)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().add_element_user(DESCRIPTION$6);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxExpirationDate()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXEXPIRATIONDATE$8, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxExpirationDate(x0401.oecdStandardAuditFileTaxPT1.SAFdateType taxExpirationDate)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXEXPIRATIONDATE$8);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$10, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxPercentage(x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$10);
                }
         ...
         */
        public x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$12, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxAmount(x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0401.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$12);
                }
