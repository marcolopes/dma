 ...
 */
public class FiscalYearDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument.FiscalYear xgetFiscalYear()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument.FiscalYear)get_store().find_element_user(FISCALYEAR$0, 0);
            return target;
        }
    }
    ...
    public void xsetFiscalYear(x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument.FiscalYear fiscalYear)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument.FiscalYear)get_store().add_element_user(FISCALYEAR$0);
            }
     ...
     */
    public static class FiscalYearImpl extends org.apache.xmlbeans.impl.values.JavaIntHolderEx implements x0401.oecdStandardAuditFileTaxPT1.FiscalYearDocument.FiscalYear
    {
        private static final long serialVersionUID = 1L;
