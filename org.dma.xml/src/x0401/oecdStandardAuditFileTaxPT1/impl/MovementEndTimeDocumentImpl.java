 ...
 */
public class MovementEndTimeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.MovementEndTimeDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetMovementEndTime()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(MOVEMENTENDTIME$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementEndTime(x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType movementEndTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(MOVEMENTENDTIME$0);
            }
