 ...
 */
public class CompanyIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument
{
    ...
    public x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument.CompanyID xgetCompanyID()
    {
        synchronized (monitor())
        {
            ...
            target = (x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument.CompanyID)get_store().find_element_user(COMPANYID$0, 0);
            return target;
        }
    }
    ...
    public void xsetCompanyID(x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument.CompanyID companyID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument.CompanyID)get_store().add_element_user(COMPANYID$0);
            }
     ...
     */
    public static class CompanyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements x0401.oecdStandardAuditFileTaxPT1.CompanyIDDocument.CompanyID
    {
        private static final long serialVersionUID = 1L;
