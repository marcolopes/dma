 ...
 */
public class InvoiceTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument.InvoiceType xgetInvoiceType()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument.InvoiceType)get_store().find_element_user(INVOICETYPE$0, 0);
            return target;
        }
    }
    ...
    public void xsetInvoiceType(x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument.InvoiceType invoiceType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument.InvoiceType)get_store().add_element_user(INVOICETYPE$0);
            }
     ...
     */
    public static class InvoiceTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0101.oecdStandardAuditFileTaxPT1.InvoiceTypeDocument.InvoiceType
    {
        private static final long serialVersionUID = 1L;
