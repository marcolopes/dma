 ...
 */
public class TaxAmountDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.TaxAmountDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxAmount(x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$0);
            }
