 ...
 */
public class TaxTableEntryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument
{
    ...
    private static final javax.xml.namespace.QName TAXTABLEENTRY$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "TaxTableEntry");
    
    
    /**
     * Gets the "TaxTableEntry" element
     */
    public x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry getTaxTableEntry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry)get_store().find_element_user(TAXTABLEENTRY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTaxTableEntry(x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry taxTableEntry)
    {
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry addNewTaxTableEntry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry)get_store().add_element_user(TAXTABLEENTRY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TaxTableEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName TAXCOUNTRYREGION$2 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "TaxCountryRegion");
        private static final javax.xml.namespace.QName TAXCODE$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "TaxCode");
        ...
        private static final javax.xml.namespace.QName TAXAMOUNT$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "TaxAmount");
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion xgetTaxCountryRegion()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion)get_store().find_element_user(TAXCOUNTRYREGION$2, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxCountryRegion(x0101.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion taxCountryRegion)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.TaxCountryRegionDocument.TaxCountryRegion)get_store().add_element_user(TAXCOUNTRYREGION$2);
                }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode xgetTaxCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().find_element_user(TAXCODE$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxCode(x0101.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode taxCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().add_element_user(TAXCODE$4);
                }
                target.set(taxCode);
            }
        }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car xgetDescription()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().find_element_user(DESCRIPTION$6, 0);
                return target;
            }
        }
         ...
         */
        public void xsetDescription(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car description)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().add_element_user(DESCRIPTION$6);
                }
        ...
        public x0101.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxExpirationDate()
        {
            synchronized (monitor())
            {
                ...
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXEXPIRATIONDATE$8, 0);
                return target;
            }
        }
        ...
        public void xsetTaxExpirationDate(x0101.oecdStandardAuditFileTaxPT1.SAFdateType taxExpirationDate)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXEXPIRATIONDATE$8);
                }
        ...
        public x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
        {
            synchronized (monitor())
            {
                ...
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$10, 0);
                return target;
            }
        }
        ...
        public void xsetTaxPercentage(x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$10);
                }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$12, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxAmount(x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$12);
                }
