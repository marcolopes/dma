 ...
 */
public class TaxDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.TaxDocument
{
    private static final long serialVersionUID = 1L;
    
    public TaxDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName TAX$0 = 
    ...
    public x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax getTax()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax)get_store().find_element_user(TAX$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(tax, TAX$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax addNewTax()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax)get_store().add_element_user(TAX$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.TaxDocument.Tax
    {
        private static final long serialVersionUID = 1L;
        ...
        public x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
        {
            synchronized (monitor())
            {
                ...
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$6, 0);
                return target;
            }
        }
        ...
        public void xsetTaxPercentage(x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$6);
                }
        ...
        public x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
        {
            synchronized (monitor())
            {
                ...
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$8, 0);
                return target;
            }
        }
        ...
        public void xsetTaxAmount(x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$8);
                }
