 ...
 */
public class AddressStructurePTImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.AddressStructurePT
{
    ...
    private static final javax.xml.namespace.QName BUILDINGNUMBER$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "BuildingNumber");
    private static final javax.xml.namespace.QName STREETNAME$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "StreetName");
    ...
    private static final javax.xml.namespace.QName REGION$10 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "Region");
    private static final javax.xml.namespace.QName COUNTRY$12 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "Country");
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car xgetBuildingNumber()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().find_element_user(BUILDINGNUMBER$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetBuildingNumber(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car buildingNumber)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().add_element_user(BUILDINGNUMBER$0);
            }
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetStreetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(STREETNAME$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetStreetName(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car streetName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(STREETNAME$2);
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetAddressDetail()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(ADDRESSDETAIL$4, 0);
            return target;
        }
    }
    ...
    public void xsetAddressDetail(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car addressDetail)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(ADDRESSDETAIL$4);
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetCity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(CITY$6, 0);
            return target;
        }
    }
    ...
    public void xsetCity(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car city)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(CITY$6);
            }
            target.set(city);
        }
    }
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.PostalCodePT xgetPostalCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.PostalCodePT target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.PostalCodePT)get_store().find_element_user(POSTALCODE$8, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPostalCode(x0101.oecdStandardAuditFileTaxPT1.PostalCodePT postalCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.PostalCodePT)get_store().add_element_user(POSTALCODE$8);
            }
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetRegion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(REGION$10, 0);
            return target;
        }
    }
     ...
     */
    public void xsetRegion(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car region)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(REGION$10);
            }
            target.set(region);
        }
    }
