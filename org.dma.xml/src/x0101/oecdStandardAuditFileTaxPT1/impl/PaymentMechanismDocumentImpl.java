 ...
 */
public class PaymentMechanismDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument.PaymentMechanism xgetPaymentMechanism()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument.PaymentMechanism)get_store().find_element_user(PAYMENTMECHANISM$0, 0);
            return target;
        }
    }
    ...
    public void xsetPaymentMechanism(x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument.PaymentMechanism paymentMechanism)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument.PaymentMechanism)get_store().add_element_user(PAYMENTMECHANISM$0);
            }
     ...
     */
    public static class PaymentMechanismImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0101.oecdStandardAuditFileTaxPT1.PaymentMechanismDocument.PaymentMechanism
    {
        private static final long serialVersionUID = 1L;
