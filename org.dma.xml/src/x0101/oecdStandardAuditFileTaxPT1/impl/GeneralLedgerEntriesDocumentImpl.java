 ...
 */
public class GeneralLedgerEntriesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries getGeneralLedgerEntries()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries)get_store().find_element_user(GENERALLEDGERENTRIES$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries addNewGeneralLedgerEntries()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries)get_store().add_element_user(GENERALLEDGERENTRIES$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class GeneralLedgerEntriesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName JOURNAL$6 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "Journal");
         ...
         */
        public java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal> getJournalList()
        {
            final class JournalList extends java.util.AbstractList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal>
            {
                @Override
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal get(int i)
                    { return GeneralLedgerEntriesImpl.this.getJournalArray(i); }
                
                @Override
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal set(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal o)
                {
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal old = GeneralLedgerEntriesImpl.this.getJournalArray(i);
                    GeneralLedgerEntriesImpl.this.setJournalArray(i, o);
                    return old;
                }
                
                @Override
                public void add(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal o)
                    { GeneralLedgerEntriesImpl.this.insertNewJournal(i).set(o); }
                
                @Override
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal remove(int i)
                {
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal old = GeneralLedgerEntriesImpl.this.getJournalArray(i);
         ...
         */
        @Deprecated
        public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] getJournalArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal> targetList = new java.util.ArrayList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal>();
                get_store().find_all_element_users(JOURNAL$6, targetList);
                x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] result = new x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[targetList.size()];
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal getJournalArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().find_element_user(JOURNAL$6, i);
                if (target == null)
                {
         ...
         */
        public void setJournalArray(x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal[] journalArray)
        {
            check_orphaned();
         ...
         */
        public void setJournalArray(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal journal)
        {
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal insertNewJournal(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().insert_element_user(JOURNAL$6, i);
                return target;
            }
        }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal addNewJournal()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal)get_store().add_element_user(JOURNAL$6);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class JournalImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal
        {
            private static final long serialVersionUID = 1L;
            ...
            private static final javax.xml.namespace.QName TRANSACTION$4 = 
                new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "Transaction");
            ...
            public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetDescription()
            {
                synchronized (monitor())
                {
                    ...
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(DESCRIPTION$2, 0);
                    return target;
                }
            }
            ...
            public void xsetDescription(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car description)
            {
                synchronized (monitor())
                {
                    ...
                    if (target == null)
                    {
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(DESCRIPTION$2);
                    }
             ...
             */
            public java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction> getTransactionList()
            {
                final class TransactionList extends java.util.AbstractList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction>
                {
                    @Override
                    public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction get(int i)
                        { return JournalImpl.this.getTransactionArray(i); }
                    
                    @Override
                    public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction set(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction o)
                    {
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction old = JournalImpl.this.getTransactionArray(i);
                      JournalImpl.this.setTransactionArray(i, o);
                      return old;
                    }
                    
                    @Override
                    public void add(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction o)
                        { JournalImpl.this.insertNewTransaction(i).set(o); }
                    
                    @Override
                    public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction remove(int i)
                    {
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction old = JournalImpl.this.getTransactionArray(i);
             ...
             */
            @Deprecated
            public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] getTransactionArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction> targetList = new java.util.ArrayList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction>();
                    get_store().find_all_element_users(TRANSACTION$4, targetList);
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] result = new x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction getTransactionArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().find_element_user(TRANSACTION$4, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setTransactionArray(x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction[] transactionArray)
            {
                check_orphaned();
             ...
             */
            public void setTransactionArray(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction transaction)
            {
             ...
             */
            public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction insertNewTransaction(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().insert_element_user(TRANSACTION$4, i);
                    return target;
                }
            }
             ...
             */
            public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction addNewTransaction()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction target = null;
                    target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction)get_store().add_element_user(TRANSACTION$4);
                    return target;
                }
            }
             ...
             * This is a complex type.
             */
            public static class TransactionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction
            {
                private static final long serialVersionUID = 1L;
                ...
                private static final javax.xml.namespace.QName SOURCEID$6 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "SourceID");
                ...
                private static final javax.xml.namespace.QName GLPOSTINGDATE$14 = 
                    new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "GLPostingDate");
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTTransactionID xgetTransactionID()
                {
                    synchronized (monitor())
                    {
                      ...
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTTransactionID)get_store().find_element_user(TRANSACTIONID$0, 0);
                      return target;
                    }
                }
                ...
                public void xsetTransactionID(x0101.oecdStandardAuditFileTaxPT1.SAFPTTransactionID transactionID)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTTransactionID)get_store().add_element_user(TRANSACTIONID$0);
                      }
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod xgetPeriod()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod)get_store().find_element_user(PERIOD$2, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void xsetPeriod(x0101.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod period)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTAccountingPeriod)get_store().add_element_user(PERIOD$2);
                      }
                      target.set(period);
                    }
                }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFdateType xgetTransactionDate()
                {
                    synchronized (monitor())
                    {
                      ...
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TRANSACTIONDATE$4, 0);
                      return target;
                    }
                }
                ...
                public void xsetTransactionDate(x0101.oecdStandardAuditFileTaxPT1.SAFdateType transactionDate)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TRANSACTIONDATE$4);
                      }
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSourceID()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SOURCEID$6, 0);
                      return target;
                    }
                }
                ...
                public boolean isSetSourceID()
                {
                    ...
                    {
                      check_orphaned();
                      return get_store().count_elements(SOURCEID$6) != 0;
                    }
                }
                 ...
                 */
                public void xsetSourceID(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car sourceID)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SOURCEID$6);
                      }
                      target.set(sourceID);
                    }
                }
                ...
                public void unsetSourceID()
                {
                    ...
                    {
                      check_orphaned();
                      get_store().remove_element(SOURCEID$6, 0);
                    }
                }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetDescription()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(DESCRIPTION$8, 0);
                      return target;
                    }
                }
                ...
                public void xsetDescription(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car description)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(DESCRIPTION$8);
                      }
                      target.set(description);
                    }
                }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber xgetDocArchivalNumber()
                {
                    synchronized (monitor())
                    {
                      ...
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().find_element_user(DOCARCHIVALNUMBER$10, 0);
                      return target;
                    }
                }
                ...
                public void xsetDocArchivalNumber(x0101.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber docArchivalNumber)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().add_element_user(DOCARCHIVALNUMBER$10);
                      }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType xgetTransactionType()
                {
                    synchronized (monitor())
                    {
                      ...
                      target = (x0101.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().find_element_user(TRANSACTIONTYPE$12, 0);
                      return target;
                    }
                }
                ...
                public void xsetTransactionType(x0101.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType transactionType)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().add_element_user(TRANSACTIONTYPE$12);
                      }
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetGLPostingDate()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(GLPOSTINGDATE$14, 0);
                      return target;
                    }
                }
                 ...
                 */
                public void xsetGLPostingDate(x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType glPostingDate)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(GLPOSTINGDATE$14);
                      }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetCustomerID()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(CUSTOMERID$16, 0);
                      return target;
                    }
                }
                ...
                public void xsetCustomerID(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car customerID)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(CUSTOMERID$16);
                      }
                ...
                public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSupplierID()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SUPPLIERID$18, 0);
                      return target;
                    }
                }
                ...
                public void xsetSupplierID(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car supplierID)
                {
                    synchronized (monitor())
                    {
                      ...
                      if (target == null)
                      {
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SUPPLIERID$18);
                      }
                 ...
                 */
                public java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line> getLineList()
                {
                    final class LineList extends java.util.AbstractList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line>
                    {
                      @Override
                      public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line get(int i)
                          { return TransactionImpl.this.getLineArray(i); }
                      
                      @Override
                      public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line set(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line o)
                      {
                        x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line old = TransactionImpl.this.getLineArray(i);
                        TransactionImpl.this.setLineArray(i, o);
                        return old;
                      }
                      
                      @Override
                      public void add(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line o)
                          { TransactionImpl.this.insertNewLine(i).set(o); }
                      
                      @Override
                      public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line remove(int i)
                      {
                        x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line old = TransactionImpl.this.getLineArray(i);
                 ...
                 */
                @Deprecated
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line[] getLineArray()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      java.util.List<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line> targetList = new java.util.ArrayList<x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line>();
                      get_store().find_all_element_users(LINE$20, targetList);
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line[] result = new x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line[targetList.size()];
                      targetList.toArray(result);
                      return result;
                    }
                }
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line getLineArray(int i)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line)get_store().find_element_user(LINE$20, i);
                      if (target == null)
                      {
                        throw new IndexOutOfBoundsException();
                      }
                 ...
                 */
                public void setLineArray(x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line[] lineArray)
                {
                    check_orphaned();
                 ...
                 */
                public void setLineArray(int i, x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line line)
                {
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line insertNewLine(int i)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line)get_store().insert_element_user(LINE$20, i);
                      return target;
                    }
                }
                 ...
                 */
                public x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line addNewLine()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line target = null;
                      target = (x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line)get_store().add_element_user(LINE$20);
                      return target;
                    }
                }
                 ...
                 * This is a complex type.
                 */
                public static class LineImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.GeneralLedgerEntriesDocument.GeneralLedgerEntries.Journal.Transaction.Line
                {
                    private static final long serialVersionUID = 1L;
                    ...
                    private static final javax.xml.namespace.QName SOURCEDOCUMENTID$4 = 
                      new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "SourceDocumentID");
                    ...
                    public x0101.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID xgetAccountID()
                    {
                      synchronized (monitor())
                      {
                        ...
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().find_element_user(ACCOUNTID$2, 0);
                        return target;
                      }
                    }
                    ...
                    public void xsetAccountID(x0101.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID accountID)
                    {
                      synchronized (monitor())
                      {
                        ...
                        if (target == null)
                        {
                          target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().add_element_user(ACCOUNTID$2);
                        }
                     ...
                     */
                    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSourceDocumentID()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SOURCEDOCUMENTID$4, 0);
                        return target;
                      }
                    }
                     ...
                     */
                    public void xsetSourceDocumentID(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car sourceDocumentID)
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        ...
                        if (target == null)
                        {
                          target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SOURCEDOCUMENTID$4);
                        }
                    ...
                    public x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetSystemEntryDate()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType target = null;
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(SYSTEMENTRYDATE$6, 0);
                        return target;
                      }
                    }
                    ...
                    public void xsetSystemEntryDate(x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType systemEntryDate)
                    {
                      synchronized (monitor())
                      {
                        ...
                        if (target == null)
                        {
                          target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(SYSTEMENTRYDATE$6);
                        }
                    ...
                    public x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetDebitAmount()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(DEBITAMOUNT$10, 0);
                        return target;
                      }
                    }
                    ...
                    public void xsetDebitAmount(x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType debitAmount)
                    {
                      synchronized (monitor())
                      {
                        ...
                        if (target == null)
                        {
                          target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(DEBITAMOUNT$10);
                        }
                    ...
                    public x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetCreditAmount()
                    {
                      synchronized (monitor())
                      {
                        check_orphaned();
                        x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                        target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CREDITAMOUNT$12, 0);
                        return target;
                      }
                    }
                    ...
                    public void xsetCreditAmount(x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType creditAmount)
                    {
                      synchronized (monitor())
                      {
                        ...
                        if (target == null)
                        {
                          target = (x0101.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CREDITAMOUNT$12);
                        }
