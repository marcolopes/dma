 ...
 */
public class HashDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.HashDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car xgetHash()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().find_element_user(HASH$0, 0);
            return target;
        }
    }
    ...
    public void xsetHash(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car hash)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax200Car)get_store().add_element_user(HASH$0);
            }
            target.set(hash);
        }
    }
