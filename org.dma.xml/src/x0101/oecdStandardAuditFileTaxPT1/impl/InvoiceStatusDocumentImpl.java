 ...
 */
public class InvoiceStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument.InvoiceStatus xgetInvoiceStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument.InvoiceStatus)get_store().find_element_user(INVOICESTATUS$0, 0);
            return target;
        }
    }
    ...
    public void xsetInvoiceStatus(x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument.InvoiceStatus invoiceStatus)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument.InvoiceStatus)get_store().add_element_user(INVOICESTATUS$0);
            }
     ...
     */
    public static class InvoiceStatusImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0101.oecdStandardAuditFileTaxPT1.InvoiceStatusDocument.InvoiceStatus
    {
        private static final long serialVersionUID = 1L;
