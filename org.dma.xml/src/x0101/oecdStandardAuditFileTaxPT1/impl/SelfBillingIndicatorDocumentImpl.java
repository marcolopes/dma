 ...
 */
public class SelfBillingIndicatorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument.SelfBillingIndicator xgetSelfBillingIndicator()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument.SelfBillingIndicator)get_store().find_element_user(SELFBILLINGINDICATOR$0, 0);
            return target;
        }
    }
    ...
    public void xsetSelfBillingIndicator(x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument.SelfBillingIndicator selfBillingIndicator)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument.SelfBillingIndicator)get_store().add_element_user(SELFBILLINGINDICATOR$0);
            }
     ...
     */
    public static class SelfBillingIndicatorImpl extends org.apache.xmlbeans.impl.values.JavaIntHolderEx implements x0101.oecdStandardAuditFileTaxPT1.SelfBillingIndicatorDocument.SelfBillingIndicator
    {
        private static final long serialVersionUID = 1L;
