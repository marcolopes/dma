 ...
 */
public class ShipFromDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.ShipFromDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure getShipFrom()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure)get_store().find_element_user(SHIPFROM$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure addNewShipFrom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure)get_store().add_element_user(SHIPFROM$0);
            return target;
        }
    }
}
