 ...
 */
public class ShipToDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.ShipToDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure getShipTo()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure)get_store().find_element_user(SHIPTO$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure addNewShipTo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.ShippingPointStructure)get_store().add_element_user(SHIPTO$0);
            return target;
        }
    }
}
