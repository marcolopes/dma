 ...
 */
public class DateCreatedDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.DateCreatedDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTDateSpan xgetDateCreated()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().find_element_user(DATECREATED$0, 0);
            return target;
        }
    }
    ...
    public void xsetDateCreated(x0101.oecdStandardAuditFileTaxPT1.SAFPTDateSpan dateCreated)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().add_element_user(DATECREATED$0);
            }
