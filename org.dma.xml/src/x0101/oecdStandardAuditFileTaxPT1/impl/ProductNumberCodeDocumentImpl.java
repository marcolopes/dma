 ...
 */
public class ProductNumberCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.ProductNumberCodeDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetProductNumberCode()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(PRODUCTNUMBERCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetProductNumberCode(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car productNumberCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(PRODUCTNUMBERCODE$0);
            }
