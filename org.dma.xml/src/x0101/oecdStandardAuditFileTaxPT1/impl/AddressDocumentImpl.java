 ...
 */
public class AddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.AddressDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.AddressStructure getAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(ADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0101.oecdStandardAuditFileTaxPT1.AddressStructure addNewAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(ADDRESS$0);
            return target;
        }
    }
}
