 ...
 */
public class SupplierDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.SupplierDocument
{
     ...
     */
    public x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier getSupplier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier)get_store().find_element_user(SUPPLIER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSupplier(x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier supplier)
    {
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier addNewSupplier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier target = null;
            target = (x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier)get_store().add_element_user(SUPPLIER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SupplierImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName SUPPLIERTAXID$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "SupplierTaxID");
        ...
        private static final javax.xml.namespace.QName SHIPFROMADDRESS$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.01_01", "ShipFromAddress");
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetSupplierTaxID()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(SUPPLIERTAXID$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetSupplierTaxID(x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car supplierTaxID)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0101.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(SUPPLIERTAXID$4);
                }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure getBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().find_element_user(BILLINGADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setBillingAddress(x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure billingAddress)
        {
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure addNewBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().add_element_user(BILLINGADDRESS$10);
                return target;
            }
        }
         ...
         */
        public x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure getShipFromAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().find_element_user(SHIPFROMADDRESS$12, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public boolean isSetShipFromAddress()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(SHIPFROMADDRESS$12) != 0;
            }
        }
         ...
         */
        public void setShipFromAddress(x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure shipFromAddress)
        {
            generatedSetterHelperImpl(shipFromAddress, SHIPFROMADDRESS$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
        }
        
        /**
         * Appends and returns a new empty "ShipFromAddress" element
         */
        public x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure addNewShipFromAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0101.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().add_element_user(SHIPFROMADDRESS$12);
                return target;
            }
        }
         ...
         */
        public void unsetShipFromAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(SHIPFROMADDRESS$12, 0);
            }
        }
