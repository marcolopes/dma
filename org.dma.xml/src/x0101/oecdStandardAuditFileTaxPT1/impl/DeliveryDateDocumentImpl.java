 ...
 */
public class DeliveryDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0101.oecdStandardAuditFileTaxPT1.DeliveryDateDocument
{
    ...
    public x0101.oecdStandardAuditFileTaxPT1.SAFdateType xgetDeliveryDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(DELIVERYDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetDeliveryDate(x0101.oecdStandardAuditFileTaxPT1.SAFdateType deliveryDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0101.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(DELIVERYDATE$0);
            }
