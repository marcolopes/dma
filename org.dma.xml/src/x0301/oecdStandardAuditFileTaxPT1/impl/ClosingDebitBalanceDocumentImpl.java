 ...
 */
public class ClosingDebitBalanceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.ClosingDebitBalanceDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetClosingDebitBalance()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CLOSINGDEBITBALANCE$0, 0);
            return target;
        }
    }
    ...
    public void xsetClosingDebitBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType closingDebitBalance)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CLOSINGDEBITBALANCE$0);
            }
