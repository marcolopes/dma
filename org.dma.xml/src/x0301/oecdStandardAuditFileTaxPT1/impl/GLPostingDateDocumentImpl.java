 ...
 */
public class GLPostingDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.GLPostingDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetGLPostingDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(GLPOSTINGDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetGLPostingDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType glPostingDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(GLPOSTINGDATE$0);
            }
