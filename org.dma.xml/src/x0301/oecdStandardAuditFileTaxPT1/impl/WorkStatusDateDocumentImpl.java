 ...
 */
public class WorkStatusDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.WorkStatusDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetWorkStatusDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(WORKSTATUSDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetWorkStatusDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType workStatusDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(WORKSTATUSDATE$0);
            }
