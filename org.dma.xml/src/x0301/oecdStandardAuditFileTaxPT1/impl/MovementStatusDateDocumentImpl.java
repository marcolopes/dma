 ...
 */
public class MovementStatusDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.MovementStatusDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetMovementStatusDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(MOVEMENTSTATUSDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementStatusDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType movementStatusDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(MOVEMENTSTATUSDATE$0);
            }
