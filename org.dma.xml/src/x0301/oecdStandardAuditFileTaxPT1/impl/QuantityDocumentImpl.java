 ...
 */
public class QuantityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.QuantityDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetQuantity()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(QUANTITY$0, 0);
            return target;
        }
    }
    ...
    public void xsetQuantity(x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType quantity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(QUANTITY$0);
            }
            target.set(quantity);
        }
    }
