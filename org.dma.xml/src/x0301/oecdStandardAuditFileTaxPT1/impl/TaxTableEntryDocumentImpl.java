 ...
 */
public class TaxTableEntryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument
{
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry getTaxTableEntry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry)get_store().find_element_user(TAXTABLEENTRY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTaxTableEntry(x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry taxTableEntry)
    {
     ...
     * This is a complex type.
     */
    public static class TaxTableEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryDocument.TaxTableEntry
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName TAXEXPIRATIONDATE$8 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "TaxExpirationDate");
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode xgetTaxCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode)get_store().find_element_user(TAXCODE$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxCode(x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode taxCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.TaxTableEntryTaxCode)get_store().add_element_user(TAXCODE$4);
                }
                target.set(taxCode);
            }
        }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car xgetDescription()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().find_element_user(DESCRIPTION$6, 0);
                return target;
            }
        }
         ...
         */
        public void xsetDescription(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car description)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax255Car)get_store().add_element_user(DESCRIPTION$6);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxExpirationDate()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXEXPIRATIONDATE$8, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxExpirationDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateType taxExpirationDate)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXEXPIRATIONDATE$8);
                }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
        {
            synchronized (monitor())
            {
                ...
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$10, 0);
                return target;
            }
        }
        ...
        public void xsetTaxPercentage(x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$10);
                }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
        {
            synchronized (monitor())
            {
                ...
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$12, 0);
                return target;
            }
        }
        ...
        public void xsetTaxAmount(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$12);
                }
