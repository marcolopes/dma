 ...
 */
public class TaxExpirationDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.TaxExpirationDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxExpirationDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXEXPIRATIONDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxExpirationDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateType taxExpirationDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXEXPIRATIONDATE$0);
            }
