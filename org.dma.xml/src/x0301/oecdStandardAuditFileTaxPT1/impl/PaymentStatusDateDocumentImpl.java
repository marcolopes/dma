 ...
 */
public class PaymentStatusDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.PaymentStatusDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetPaymentStatusDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(PAYMENTSTATUSDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetPaymentStatusDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType paymentStatusDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(PAYMENTSTATUSDATE$0);
            }
