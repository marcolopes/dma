 ...
 */
public class CurrencyAmountDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.CurrencyAmountDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetCurrencyAmount()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CURRENCYAMOUNT$0, 0);
            return target;
        }
    }
    ...
    public void xsetCurrencyAmount(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType currencyAmount)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CURRENCYAMOUNT$0);
            }
