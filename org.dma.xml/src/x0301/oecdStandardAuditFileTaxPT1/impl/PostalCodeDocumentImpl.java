 ...
 */
public class PostalCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.PostalCodeDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetPostalCode()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(POSTALCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetPostalCode(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car postalCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(POSTALCODE$0);
            }
