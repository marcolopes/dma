 ...
 */
public class TaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.Tax
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode xgetTaxCode()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().find_element_user(TAXCODE$4, 0);
            return target;
        }
    }
    ...
    public void xsetTaxCode(x0301.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode taxCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.TaxCodeDocument.TaxCode)get_store().add_element_user(TAXCODE$4);
            }
            target.set(taxCode);
        }
    }
