 ...
 */
public class OpeningDebitBalanceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.OpeningDebitBalanceDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetOpeningDebitBalance()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(OPENINGDEBITBALANCE$0, 0);
            return target;
        }
    }
    ...
    public void xsetOpeningDebitBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType openingDebitBalance)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(OPENINGDEBITBALANCE$0);
            }
