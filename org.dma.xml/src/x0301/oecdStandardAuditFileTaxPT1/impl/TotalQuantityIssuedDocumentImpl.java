 ...
 */
public class TotalQuantityIssuedDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.TotalQuantityIssuedDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTotalQuantityIssued()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TOTALQUANTITYISSUED$0, 0);
            return target;
        }
    }
    ...
    public void xsetTotalQuantityIssued(x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType totalQuantityIssued)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TOTALQUANTITYISSUED$0);
            }
