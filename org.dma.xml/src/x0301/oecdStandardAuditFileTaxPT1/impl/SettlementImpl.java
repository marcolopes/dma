 ...
 */
public class SettlementImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.Settlement
{
    ...
    private static final javax.xml.namespace.QName SETTLEMENTDISCOUNT$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "SettlementDiscount");
    ...
    private static final javax.xml.namespace.QName SETTLEMENTDATE$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "SettlementDate");
    private static final javax.xml.namespace.QName PAYMENTTERMS$6 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "PaymentTerms");
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSettlementDiscount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SETTLEMENTDISCOUNT$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetSettlementDiscount(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car settlementDiscount)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SETTLEMENTDISCOUNT$0);
            }
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetSettlementAmount()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(SETTLEMENTAMOUNT$2, 0);
            return target;
        }
    }
    ...
    public void xsetSettlementAmount(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType settlementAmount)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(SETTLEMENTAMOUNT$2);
            }
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateType xgetSettlementDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(SETTLEMENTDATE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetSettlementDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateType settlementDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(SETTLEMENTDATE$4);
            }
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car xgetPaymentTerms()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().find_element_user(PAYMENTTERMS$6, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPaymentTerms(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car paymentTerms)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().add_element_user(PAYMENTTERMS$6);
            }
