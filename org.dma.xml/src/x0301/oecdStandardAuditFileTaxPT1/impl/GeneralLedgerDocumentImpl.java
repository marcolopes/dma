 ...
 */
public class GeneralLedgerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument
{
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument.GeneralLedger getGeneralLedger()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument.GeneralLedger target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument.GeneralLedger)get_store().find_element_user(GENERALLEDGER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGeneralLedger(x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument.GeneralLedger generalLedger)
    {
     ...
     * This is a complex type.
     */
    public static class GeneralLedgerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.GeneralLedgerDocument.GeneralLedger
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName OPENINGDEBITBALANCE$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "OpeningDebitBalance");
        ...
        private static final javax.xml.namespace.QName CLOSINGDEBITBALANCE$8 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "ClosingDebitBalance");
        ...
        private static final javax.xml.namespace.QName GROUPINGCATEGORY$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "GroupingCategory");
        private static final javax.xml.namespace.QName GROUPINGCODE$14 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.03_01", "GroupingCode");
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID xgetAccountID()
        {
            synchronized (monitor())
            {
                ...
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().find_element_user(ACCOUNTID$0, 0);
                return target;
            }
        }
        ...
        public void xsetAccountID(x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID accountID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().add_element_user(ACCOUNTID$0);
                }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetAccountDescription()
        {
            synchronized (monitor())
            {
                ...
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(ACCOUNTDESCRIPTION$2, 0);
                return target;
            }
        }
        ...
        public void xsetAccountDescription(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car accountDescription)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(ACCOUNTDESCRIPTION$2);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetOpeningDebitBalance()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(OPENINGDEBITBALANCE$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetOpeningDebitBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType openingDebitBalance)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(OPENINGDEBITBALANCE$4);
                }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetOpeningCreditBalance()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(OPENINGCREDITBALANCE$6, 0);
                return target;
            }
        }
        ...
        public void xsetOpeningCreditBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType openingCreditBalance)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(OPENINGCREDITBALANCE$6);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetClosingDebitBalance()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CLOSINGDEBITBALANCE$8, 0);
                return target;
            }
        }
         ...
         */
        public void xsetClosingDebitBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType closingDebitBalance)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CLOSINGDEBITBALANCE$8);
                }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetClosingCreditBalance()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CLOSINGCREDITBALANCE$10, 0);
                return target;
            }
        }
        ...
        public void xsetClosingCreditBalance(x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType closingCreditBalance)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CLOSINGCREDITBALANCE$10);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory.Enum getGroupingCategory()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory xgetGroupingCategory()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory)get_store().find_element_user(GROUPINGCATEGORY$12, 0);
                return target;
            }
        }
         ...
         */
        public void setGroupingCategory(x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory.Enum groupingCategory)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetGroupingCategory(x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory groupingCategory)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.GroupingCategoryDocument.GroupingCategory)get_store().add_element_user(GROUPINGCATEGORY$12);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID xgetGroupingCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().find_element_user(GROUPINGCODE$14, 0);
                return target;
            }
        }
         ...
         */
        public void xsetGroupingCode(x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID groupingCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTGLAccountID)get_store().add_element_user(GROUPINGCODE$14);
                }
