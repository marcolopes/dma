 ...
 */
public class SystemEntryDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.SystemEntryDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetSystemEntryDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(SYSTEMENTRYDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetSystemEntryDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType systemEntryDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(SYSTEMENTRYDATE$0);
            }
