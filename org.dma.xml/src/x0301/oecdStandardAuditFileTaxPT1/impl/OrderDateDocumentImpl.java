 ...
 */
public class OrderDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.OrderDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateType xgetOrderDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(ORDERDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetOrderDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateType orderDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(ORDERDATE$0);
            }
