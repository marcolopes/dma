 ...
 */
public class CustomerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.CustomerDocument
{
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer getCustomer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer)get_store().find_element_user(CUSTOMER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCustomer(x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer customer)
    {
    ...
    public x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer addNewCustomer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer)get_store().add_element_user(CUSTOMER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CustomerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.CustomerDocument.Customer
    {
        private static final long serialVersionUID = 1L;
        ...
        public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetCustomerTaxID()
        {
            synchronized (monitor())
            {
                ...
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(CUSTOMERTAXID$4, 0);
                return target;
            }
        }
        ...
        public void xsetCustomerTaxID(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car customerTaxID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(CUSTOMERTAXID$4);
                }
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure getBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(BILLINGADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setBillingAddress(x0301.oecdStandardAuditFileTaxPT1.AddressStructure billingAddress)
        {
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure addNewBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(BILLINGADDRESS$10);
                return target;
            }
        }
         ...
         */
        public java.util.List<x0301.oecdStandardAuditFileTaxPT1.AddressStructure> getShipToAddressList()
        {
            final class ShipToAddressList extends java.util.AbstractList<x0301.oecdStandardAuditFileTaxPT1.AddressStructure>
            {
                @Override
                public x0301.oecdStandardAuditFileTaxPT1.AddressStructure get(int i)
                    { return CustomerImpl.this.getShipToAddressArray(i); }
                
                @Override
                public x0301.oecdStandardAuditFileTaxPT1.AddressStructure set(int i, x0301.oecdStandardAuditFileTaxPT1.AddressStructure o)
                {
                    x0301.oecdStandardAuditFileTaxPT1.AddressStructure old = CustomerImpl.this.getShipToAddressArray(i);
                    CustomerImpl.this.setShipToAddressArray(i, o);
                    return old;
                }
                
                @Override
                public void add(int i, x0301.oecdStandardAuditFileTaxPT1.AddressStructure o)
                    { CustomerImpl.this.insertNewShipToAddress(i).set(o); }
                
                @Override
                public x0301.oecdStandardAuditFileTaxPT1.AddressStructure remove(int i)
                {
                    x0301.oecdStandardAuditFileTaxPT1.AddressStructure old = CustomerImpl.this.getShipToAddressArray(i);
         ...
         */
        @Deprecated
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure[] getShipToAddressArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                java.util.List<x0301.oecdStandardAuditFileTaxPT1.AddressStructure> targetList = new java.util.ArrayList<x0301.oecdStandardAuditFileTaxPT1.AddressStructure>();
                get_store().find_all_element_users(SHIPTOADDRESS$12, targetList);
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure[] result = new x0301.oecdStandardAuditFileTaxPT1.AddressStructure[targetList.size()];
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure getShipToAddressArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(SHIPTOADDRESS$12, i);
                if (target == null)
                {
         ...
         */
        public void setShipToAddressArray(x0301.oecdStandardAuditFileTaxPT1.AddressStructure[] shipToAddressArray)
        {
            check_orphaned();
         ...
         */
        public void setShipToAddressArray(int i, x0301.oecdStandardAuditFileTaxPT1.AddressStructure shipToAddress)
        {
         ...
         */
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure insertNewShipToAddress(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().insert_element_user(SHIPTOADDRESS$12, i);
                return target;
            }
        }
        ...
        public x0301.oecdStandardAuditFileTaxPT1.AddressStructure addNewShipToAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0301.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
                target = (x0301.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(SHIPTOADDRESS$12);
                return target;
            }
        }
