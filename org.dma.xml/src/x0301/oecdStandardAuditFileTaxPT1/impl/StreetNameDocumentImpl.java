 ...
 */
public class StreetNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.StreetNameDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car xgetStreetName()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car)get_store().find_element_user(STREETNAME$0, 0);
            return target;
        }
    }
    ...
    public void xsetStreetName(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car streetName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car)get_store().add_element_user(STREETNAME$0);
            }
