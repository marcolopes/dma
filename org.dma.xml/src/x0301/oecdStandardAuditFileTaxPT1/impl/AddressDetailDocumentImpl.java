 ...
 */
public class AddressDetailDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.AddressDetailDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car xgetAddressDetail()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().find_element_user(ADDRESSDETAIL$0, 0);
            return target;
        }
    }
    ...
    public void xsetAddressDetail(x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car addressDetail)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().add_element_user(ADDRESSDETAIL$0);
            }
