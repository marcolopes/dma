 ...
 */
public class AddressStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.AddressStructure
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country xgetCountry()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().find_element_user(COUNTRY$12, 0);
            return target;
        }
    }
    ...
    public void xsetCountry(x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country country)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().add_element_user(COUNTRY$12);
            }
            target.set(country);
        }
    }
