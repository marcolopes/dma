 ...
 */
public class CountryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.CountryDocument
{
     ...
     */
    public x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country xgetCountry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country target = null;
            target = (x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().find_element_user(COUNTRY$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCountry(x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country country)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().add_element_user(COUNTRY$0);
            }
            target.set(country);
        }
    }
     ...
     */
    public static class CountryImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements x0301.oecdStandardAuditFileTaxPT1.CountryDocument.Country
    {
        private static final long serialVersionUID = 1L;
