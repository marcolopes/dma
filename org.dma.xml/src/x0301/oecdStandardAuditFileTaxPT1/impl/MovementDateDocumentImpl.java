 ...
 */
public class MovementDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0301.oecdStandardAuditFileTaxPT1.MovementDateDocument
{
    ...
    public x0301.oecdStandardAuditFileTaxPT1.SAFdateType xgetMovementDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(MOVEMENTDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementDate(x0301.oecdStandardAuditFileTaxPT1.SAFdateType movementDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0301.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(MOVEMENTDATE$0);
            }
