 ...
 */
public class StockHeaderDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT102.StockHeaderDocument
{
     ...
     * This is a complex type.
     */
    public static class StockHeaderImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT102.StockHeaderDocument.StockHeader
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName FILEVERSION$0 = 
            new javax.xml.namespace.QName("urn:StockFile:PT_1_02", "FileVersion");
        private static final javax.xml.namespace.QName TAXREGISTRATIONNUMBER$2 = 
            new javax.xml.namespace.QName("urn:StockFile:PT_1_02", "TaxRegistrationNumber");
        private static final javax.xml.namespace.QName FISCALYEAR$4 = 
            new javax.xml.namespace.QName("urn:StockFile:PT_1_02", "FiscalYear");
        ...
        private static final javax.xml.namespace.QName NOSTOCK$8 = 
            new javax.xml.namespace.QName("urn:StockFile:PT_1_02", "NoStock");
         ...
         */
        public stockFilePT102.FileVersionDocument.FileVersion xgetFileVersion()
        {
            synchronized (monitor())
            {
                check_orphaned();
                stockFilePT102.FileVersionDocument.FileVersion target = null;
                target = (stockFilePT102.FileVersionDocument.FileVersion)get_store().find_element_user(FILEVERSION$0, 0);
                return target;
            }
        }
         ...
         */
        public void xsetFileVersion(stockFilePT102.FileVersionDocument.FileVersion fileVersion)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (stockFilePT102.FileVersionDocument.FileVersion)get_store().add_element_user(FILEVERSION$0);
                }
         ...
         */
        public stockFilePT102.SAFPTPortugueseVatNumber xgetTaxRegistrationNumber()
        {
            synchronized (monitor())
            {
                check_orphaned();
                stockFilePT102.SAFPTPortugueseVatNumber target = null;
                target = (stockFilePT102.SAFPTPortugueseVatNumber)get_store().find_element_user(TAXREGISTRATIONNUMBER$2, 0);
                return target;
            }
        }
         ...
         */
        public void xsetTaxRegistrationNumber(stockFilePT102.SAFPTPortugueseVatNumber taxRegistrationNumber)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (stockFilePT102.SAFPTPortugueseVatNumber)get_store().add_element_user(TAXREGISTRATIONNUMBER$2);
                }
         ...
         */
        public stockFilePT102.FiscalYearDocument.FiscalYear xgetFiscalYear()
        {
            synchronized (monitor())
            {
                check_orphaned();
                stockFilePT102.FiscalYearDocument.FiscalYear target = null;
                target = (stockFilePT102.FiscalYearDocument.FiscalYear)get_store().find_element_user(FISCALYEAR$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetFiscalYear(stockFilePT102.FiscalYearDocument.FiscalYear fiscalYear)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (stockFilePT102.FiscalYearDocument.FiscalYear)get_store().add_element_user(FISCALYEAR$4);
                }
        ...
        public stockFilePT102.SAFPTDateSpan xgetEndDate()
        {
            synchronized (monitor())
            {
                ...
                target = (stockFilePT102.SAFPTDateSpan)get_store().find_element_user(ENDDATE$6, 0);
                return target;
            }
        }
        ...
        public void xsetEndDate(stockFilePT102.SAFPTDateSpan endDate)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (stockFilePT102.SAFPTDateSpan)get_store().add_element_user(ENDDATE$6);
                }
                target.set(endDate);
            }
        }
