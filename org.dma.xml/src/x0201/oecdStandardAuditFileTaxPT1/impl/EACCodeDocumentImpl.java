 ...
 * Java type: x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument
 *
 * Automatically generated - do not modify.
 */
package x0201.oecdStandardAuditFileTaxPT1.impl;
/**
 * A document containing one EACCode(@urn:OECD:StandardAuditFile-Tax:PT_1.02_01) element.
 *
 * This is a complex type.
 */
public class EACCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument.EACCode xgetEACCode()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument.EACCode)get_store().find_element_user(EACCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetEACCode(x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument.EACCode eacCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument.EACCode)get_store().add_element_user(EACCODE$0);
            }
            target.set(eacCode);
        }
    }
    /**
     * An XML EACCode(@urn:OECD:StandardAuditFile-Tax:PT_1.02_01).
     *
     * This is an atomic type that is a restriction of x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument$EACCode.
     */
    public static class EACCodeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements x0201.oecdStandardAuditFileTaxPT1.EACCodeDocument.EACCode
    {
        private static final long serialVersionUID = 1L;
