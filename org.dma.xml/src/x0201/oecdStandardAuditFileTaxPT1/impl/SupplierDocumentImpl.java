 ...
 */
public class SupplierDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.SupplierDocument
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier getSupplier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier)get_store().find_element_user(SUPPLIER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSupplier(x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier supplier)
    {
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier addNewSupplier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier)get_store().add_element_user(SUPPLIER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SupplierImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.SupplierDocument.Supplier
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName SUPPLIERTAXID$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "SupplierTaxID");
        ...
        private static final javax.xml.namespace.QName SHIPFROMADDRESS$12 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "ShipFromAddress");
        ...
        public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetSupplierID()
        {
            synchronized (monitor())
            {
                ...
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(SUPPLIERID$0, 0);
                return target;
            }
        }
        ...
        public void xsetSupplierID(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car supplierID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(SUPPLIERID$0);
                }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetSupplierTaxID()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(SUPPLIERTAXID$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetSupplierTaxID(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car supplierTaxID)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(SUPPLIERTAXID$4);
                }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure getBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().find_element_user(BILLINGADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setBillingAddress(x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure billingAddress)
        {
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure addNewBillingAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().add_element_user(BILLINGADDRESS$10);
                return target;
            }
        }
         ...
         */
        public java.util.List<x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure> getShipFromAddressList()
        {
            final class ShipFromAddressList extends java.util.AbstractList<x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure>
            {
                @Override
                public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure get(int i)
                    { return SupplierImpl.this.getShipFromAddressArray(i); }
                
                @Override
                public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure set(int i, x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure o)
                {
                    x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure old = SupplierImpl.this.getShipFromAddressArray(i);
                    SupplierImpl.this.setShipFromAddressArray(i, o);
                    return old;
                }
                
                @Override
                public void add(int i, x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure o)
                    { SupplierImpl.this.insertNewShipFromAddress(i).set(o); }
                
                @Override
                public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure remove(int i)
                {
                    x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure old = SupplierImpl.this.getShipFromAddressArray(i);
         ...
         */
        @Deprecated
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure[] getShipFromAddressArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                java.util.List<x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure> targetList = new java.util.ArrayList<x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure>();
                get_store().find_all_element_users(SHIPFROMADDRESS$12, targetList);
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure[] result = new x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure[targetList.size()];
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure getShipFromAddressArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().find_element_user(SHIPFROMADDRESS$12, i);
                if (target == null)
                {
         ...
         */
        public void setShipFromAddressArray(x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure[] shipFromAddressArray)
        {
            check_orphaned();
         ...
         */
        public void setShipFromAddressArray(int i, x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure shipFromAddress)
        {
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure insertNewShipFromAddress(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().insert_element_user(SHIPFROMADDRESS$12, i);
                return target;
            }
        }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure addNewShipFromAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure)get_store().add_element_user(SHIPFROMADDRESS$12);
                return target;
            }
        }
