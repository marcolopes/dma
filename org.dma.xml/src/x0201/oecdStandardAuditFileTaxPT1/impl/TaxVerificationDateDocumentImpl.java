 ...
 */
public class TaxVerificationDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TaxVerificationDateDocument
{
    ...
    private static final javax.xml.namespace.QName TAXVERIFICATIONDATE$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "TaxVerificationDate");
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxVerificationDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXVERIFICATIONDATE$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTaxVerificationDate(x0201.oecdStandardAuditFileTaxPT1.SAFdateType taxVerificationDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXVERIFICATIONDATE$0);
            }
