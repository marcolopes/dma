 ...
 */
public class TransactionDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TransactionDateDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateType xgetTransactionDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TRANSACTIONDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTransactionDate(x0201.oecdStandardAuditFileTaxPT1.SAFdateType transactionDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TRANSACTIONDATE$0);
            }
