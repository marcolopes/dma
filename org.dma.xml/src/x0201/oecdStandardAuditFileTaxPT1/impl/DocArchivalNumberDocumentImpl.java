 ...
 */
public class DocArchivalNumberDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.DocArchivalNumberDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber xgetDocArchivalNumber()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().find_element_user(DOCARCHIVALNUMBER$0, 0);
            return target;
        }
    }
    ...
    public void xsetDocArchivalNumber(x0201.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber docArchivalNumber)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFTPTDocArchivalNumber)get_store().add_element_user(DOCARCHIVALNUMBER$0);
            }
