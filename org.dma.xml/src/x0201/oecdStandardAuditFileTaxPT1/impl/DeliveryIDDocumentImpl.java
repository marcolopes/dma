 ...
 */
public class DeliveryIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.DeliveryIDDocument
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetDeliveryID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(DELIVERYID$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetDeliveryID(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car deliveryID)
    {
        synchronized (monitor())
        {
            check_orphaned();
