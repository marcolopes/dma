 ...
 */
public class UnitPriceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.UnitPriceDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetUnitPrice()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(UNITPRICE$0, 0);
            return target;
        }
    }
    ...
    public void xsetUnitPrice(x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType unitPrice)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(UNITPRICE$0);
            }
