 ...
 */
public class CurrencyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.Currency
{
    ...
    private static final javax.xml.namespace.QName CURRENCYAMOUNT$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "CurrencyAmount");
    private static final javax.xml.namespace.QName EXCHANGERATE$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "ExchangeRate");
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetCurrencyAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(CURRENCYAMOUNT$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCurrencyAmount(x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType currencyAmount)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(CURRENCYAMOUNT$2);
            }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetExchangeRate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(EXCHANGERATE$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetExchangeRate(x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType exchangeRate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(EXCHANGERATE$4);
            }
