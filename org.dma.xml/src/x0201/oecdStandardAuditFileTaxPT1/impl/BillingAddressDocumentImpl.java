 ...
 */
public class BillingAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.BillingAddressDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.AddressStructure getBillingAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(BILLINGADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public x0201.oecdStandardAuditFileTaxPT1.AddressStructure addNewBillingAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(BILLINGADDRESS$0);
            return target;
        }
    }
}
