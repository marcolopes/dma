 ...
 */
public class ProductDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.ProductDocument
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product getProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product)get_store().find_element_user(PRODUCT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setProduct(x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product product)
    {
    ...
    public x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product addNewProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product)get_store().add_element_user(PRODUCT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ProductImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.ProductDocument.Product
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName PRODUCTTYPE$0 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "ProductType");
        ...
        private static final javax.xml.namespace.QName PRODUCTGROUP$4 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "ProductGroup");
        ...
        private static final javax.xml.namespace.QName PRODUCTNUMBERCODE$8 = 
            new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "ProductNumberCode");
        
        
        /**
         * Gets the "ProductType" element
         */
        public x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum getProductType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType xgetProductType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType)get_store().find_element_user(PRODUCTTYPE$0, 0);
                return target;
            }
        }
         ...
         */
        public void setProductType(x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType.Enum productType)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetProductType(x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType productType)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.ProductTypeDocument.ProductType)get_store().add_element_user(PRODUCTTYPE$0);
                }
        ...
        public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car xgetProductCode()
        {
            synchronized (monitor())
            {
                ...
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().find_element_user(PRODUCTCODE$2, 0);
                return target;
            }
        }
        ...
        public void xsetProductCode(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car productCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax30Car)get_store().add_element_user(PRODUCTCODE$2);
                }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetProductGroup()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(PRODUCTGROUP$4, 0);
                return target;
            }
        }
         ...
         */
        public void xsetProductGroup(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car productGroup)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(PRODUCTGROUP$4);
                }
         ...
         */
        public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetProductNumberCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(PRODUCTNUMBERCODE$8, 0);
                return target;
            }
        }
         ...
         */
        public void xsetProductNumberCode(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car productNumberCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(PRODUCTNUMBERCODE$8);
                }
