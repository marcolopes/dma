 ...
 */
public class MovementStartTimeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.MovementStartTimeDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetMovementStartTime()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(MOVEMENTSTARTTIME$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementStartTime(x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType movementStartTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(MOVEMENTSTARTTIME$0);
            }
