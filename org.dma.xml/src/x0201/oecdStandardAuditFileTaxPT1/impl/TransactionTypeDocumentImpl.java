 ...
 */
public class TransactionTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType xgetTransactionType()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().find_element_user(TRANSACTIONTYPE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTransactionType(x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType transactionType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType)get_store().add_element_user(TRANSACTIONTYPE$0);
            }
     ...
     */
    public static class TransactionTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements x0201.oecdStandardAuditFileTaxPT1.TransactionTypeDocument.TransactionType
    {
        private static final long serialVersionUID = 1L;
