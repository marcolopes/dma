 ...
 * Java type: x0201.oecdStandardAuditFileTaxPT1.MovementEndTimeDocument
 *
 * Automatically generated - do not modify.
 */
package x0201.oecdStandardAuditFileTaxPT1.impl;
/**
 * A document containing one MovementEndTime(@urn:OECD:StandardAuditFile-Tax:PT_1.02_01) element.
 *
 * This is a complex type.
 */
public class MovementEndTimeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.MovementEndTimeDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType xgetMovementEndTime()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().find_element_user(MOVEMENTENDTIME$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementEndTime(x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType movementEndTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateTimeType)get_store().add_element_user(MOVEMENTENDTIME$0);
            }
