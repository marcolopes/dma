 ...
 */
public class TaxPercentageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TaxPercentageDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType xgetTaxPercentage()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().find_element_user(TAXPERCENTAGE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxPercentage(x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType taxPercentage)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdecimalType)get_store().add_element_user(TAXPERCENTAGE$0);
            }
