 ...
 */
public class ShipToAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.ShipToAddressDocument
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.AddressStructure getShipToAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().find_element_user(SHIPTOADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setShipToAddress(x0201.oecdStandardAuditFileTaxPT1.AddressStructure shipToAddress)
    {
    ...
    public x0201.oecdStandardAuditFileTaxPT1.AddressStructure addNewShipToAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.AddressStructure target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.AddressStructure)get_store().add_element_user(SHIPTOADDRESS$0);
            return target;
        }
    }
}
