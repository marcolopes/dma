 ...
 */
public class TaxPointDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TaxPointDateDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateType xgetTaxPointDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(TAXPOINTDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxPointDate(x0201.oecdStandardAuditFileTaxPT1.SAFdateType taxPointDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(TAXPOINTDATE$0);
            }
