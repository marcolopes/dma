 ...
 */
public class GrossTotalDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.GrossTotalDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetGrossTotal()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(GROSSTOTAL$0, 0);
            return target;
        }
    }
    ...
    public void xsetGrossTotal(x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType grossTotal)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(GROSSTOTAL$0);
            }
