 ...
 */
public class SupplierAddressStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.SupplierAddressStructure
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SupplierCountry xgetCountry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SupplierCountry target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SupplierCountry)get_store().find_element_user(COUNTRY$12, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCountry(x0201.oecdStandardAuditFileTaxPT1.SupplierCountry country)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SupplierCountry)get_store().add_element_user(COUNTRY$12);
            }
            target.set(country);
        }
    }
