 ...
 */
public class AccountIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument.AccountID xgetAccountID()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument.AccountID)get_store().find_element_user(ACCOUNTID$0, 0);
            return target;
        }
    }
    ...
    public void xsetAccountID(x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument.AccountID accountID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument.AccountID)get_store().add_element_user(ACCOUNTID$0);
            }
     ...
     */
    public static class AccountIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements x0201.oecdStandardAuditFileTaxPT1.AccountIDDocument.AccountID
    {
        private static final long serialVersionUID = 1L;
