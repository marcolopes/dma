 ...
 */
public class OrderReferencesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.OrderReferences
{
    ...
    private static final javax.xml.namespace.QName ORIGINATINGON$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "OriginatingON");
    private static final javax.xml.namespace.QName ORDERDATE$2 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "OrderDate");
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetOriginatingON()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(ORIGINATINGON$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetOriginatingON(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car originatingON)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(ORIGINATINGON$0);
            }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateType xgetOrderDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFdateType target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(ORDERDATE$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetOrderDate(x0201.oecdStandardAuditFileTaxPT1.SAFdateType orderDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(ORDERDATE$2);
            }
