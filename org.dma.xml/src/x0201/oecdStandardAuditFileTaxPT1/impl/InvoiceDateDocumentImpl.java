 ...
 */
public class InvoiceDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.InvoiceDateDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFdateType xgetInvoiceDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().find_element_user(INVOICEDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetInvoiceDate(x0201.oecdStandardAuditFileTaxPT1.SAFdateType invoiceDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFdateType)get_store().add_element_user(INVOICEDATE$0);
            }
