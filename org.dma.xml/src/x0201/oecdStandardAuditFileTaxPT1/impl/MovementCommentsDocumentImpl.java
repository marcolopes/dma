 ...
 */
public class MovementCommentsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.MovementCommentsDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car xgetMovementComments()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(MOVEMENTCOMMENTS$0, 0);
            return target;
        }
    }
    ...
    public void xsetMovementComments(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car movementComments)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(MOVEMENTCOMMENTS$0);
            }
