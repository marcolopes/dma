 ...
 */
public class EndDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.EndDateDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTDateSpan xgetEndDate()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().find_element_user(ENDDATE$0, 0);
            return target;
        }
    }
    ...
    public void xsetEndDate(x0201.oecdStandardAuditFileTaxPT1.SAFPTDateSpan endDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTDateSpan)get_store().add_element_user(ENDDATE$0);
            }
            target.set(endDate);
        }
    }
