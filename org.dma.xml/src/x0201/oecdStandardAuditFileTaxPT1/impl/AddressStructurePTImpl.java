 ...
 */
public class AddressStructurePTImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.AddressStructurePT
{
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.PostalCodePT xgetPostalCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.PostalCodePT target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.PostalCodePT)get_store().find_element_user(POSTALCODE$8, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPostalCode(x0201.oecdStandardAuditFileTaxPT1.PostalCodePT postalCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.PostalCodePT)get_store().add_element_user(POSTALCODE$8);
            }
