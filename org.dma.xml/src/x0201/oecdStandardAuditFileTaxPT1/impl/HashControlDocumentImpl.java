 ...
 */
public class HashControlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.HashControlDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax40Car xgetHashControl()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax40Car)get_store().find_element_user(HASHCONTROL$0, 0);
            return target;
        }
    }
    ...
    public void xsetHashControl(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax40Car hashControl)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax40Car)get_store().add_element_user(HASHCONTROL$0);
            }
