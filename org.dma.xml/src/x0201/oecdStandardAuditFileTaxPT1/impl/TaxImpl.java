 ...
 */
public class TaxImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.Tax
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType xgetTaxAmount()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().find_element_user(TAXAMOUNT$8, 0);
            return target;
        }
    }
    ...
    public void xsetTaxAmount(x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType taxAmount)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFmonetaryType)get_store().add_element_user(TAXAMOUNT$8);
            }
