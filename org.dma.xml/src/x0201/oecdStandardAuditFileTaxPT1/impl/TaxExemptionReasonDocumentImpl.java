 ...
 */
public class TaxExemptionReasonDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.TaxExemptionReasonDocument
{
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemption xgetTaxExemptionReason()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemption)get_store().find_element_user(TAXEXEMPTIONREASON$0, 0);
            return target;
        }
    }
    ...
    public void xsetTaxExemptionReason(x0201.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemption taxExemptionReason)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTPortugueseTaxExemption)get_store().add_element_user(TAXEXEMPTIONREASON$0);
            }
