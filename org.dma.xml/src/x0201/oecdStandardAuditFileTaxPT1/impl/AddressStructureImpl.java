 ...
 */
public class AddressStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements x0201.oecdStandardAuditFileTaxPT1.AddressStructure
{
    ...
    private static final javax.xml.namespace.QName BUILDINGNUMBER$0 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "BuildingNumber");
    ...
    private static final javax.xml.namespace.QName ADDRESSDETAIL$4 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "AddressDetail");
    private static final javax.xml.namespace.QName CITY$6 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "City");
    private static final javax.xml.namespace.QName POSTALCODE$8 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "PostalCode");
    private static final javax.xml.namespace.QName REGION$10 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "Region");
    private static final javax.xml.namespace.QName COUNTRY$12 = 
        new javax.xml.namespace.QName("urn:OECD:StandardAuditFile-Tax:PT_1.02_01", "Country");
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car xgetBuildingNumber()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().find_element_user(BUILDINGNUMBER$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetBuildingNumber(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car buildingNumber)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax10Car)get_store().add_element_user(BUILDINGNUMBER$0);
            }
    ...
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car xgetStreetName()
    {
        synchronized (monitor())
        {
            ...
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car)get_store().find_element_user(STREETNAME$2, 0);
            return target;
        }
    }
    ...
    public void xsetStreetName(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car streetName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax90Car)get_store().add_element_user(STREETNAME$2);
            }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car xgetAddressDetail()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().find_element_user(ADDRESSDETAIL$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetAddressDetail(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car addressDetail)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax100Car)get_store().add_element_user(ADDRESSDETAIL$4);
            }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetCity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(CITY$6, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCity(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car city)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(CITY$6);
            }
            target.set(city);
        }
    }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car xgetPostalCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(POSTALCODE$8, 0);
            return target;
        }
    }
     ...
     */
    public void xsetPostalCode(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car postalCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(POSTALCODE$8);
            }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car xgetRegion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().find_element_user(REGION$10, 0);
            return target;
        }
    }
     ...
     */
    public void xsetRegion(x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car region)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.SAFPTtextTypeMandatoryMax50Car)get_store().add_element_user(REGION$10);
            }
            target.set(region);
        }
    }
     ...
     */
    public x0201.oecdStandardAuditFileTaxPT1.CountryDocument.Country xgetCountry()
    {
        synchronized (monitor())
        {
            check_orphaned();
            x0201.oecdStandardAuditFileTaxPT1.CountryDocument.Country target = null;
            target = (x0201.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().find_element_user(COUNTRY$12, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCountry(x0201.oecdStandardAuditFileTaxPT1.CountryDocument.Country country)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (x0201.oecdStandardAuditFileTaxPT1.CountryDocument.Country)get_store().add_element_user(COUNTRY$12);
            }
            target.set(country);
        }
    }
