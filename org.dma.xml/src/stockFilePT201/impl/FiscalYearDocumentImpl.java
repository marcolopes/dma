 ...
 */
public class FiscalYearDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT201.FiscalYearDocument
{
    ...
    public stockFilePT201.FiscalYearDocument.FiscalYear xgetFiscalYear()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT201.FiscalYearDocument.FiscalYear)get_store().find_element_user(FISCALYEAR$0, 0);
            return target;
        }
    }
    ...
    public void xsetFiscalYear(stockFilePT201.FiscalYearDocument.FiscalYear fiscalYear)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT201.FiscalYearDocument.FiscalYear)get_store().add_element_user(FISCALYEAR$0);
            }
     ...
     */
    public static class FiscalYearImpl extends org.apache.xmlbeans.impl.values.JavaIntHolderEx implements stockFilePT201.FiscalYearDocument.FiscalYear
    {
        private static final long serialVersionUID = 1L;
