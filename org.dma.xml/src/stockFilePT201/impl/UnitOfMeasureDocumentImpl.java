 ...
 */
public class UnitOfMeasureDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT201.UnitOfMeasureDocument
{
    ...
    public stockFilePT201.SAFPTtextTypeMandatoryMax20Car xgetUnitOfMeasure()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT201.SAFPTtextTypeMandatoryMax20Car)get_store().find_element_user(UNITOFMEASURE$0, 0);
            return target;
        }
    }
    ...
    public void xsetUnitOfMeasure(stockFilePT201.SAFPTtextTypeMandatoryMax20Car unitOfMeasure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT201.SAFPTtextTypeMandatoryMax20Car)get_store().add_element_user(UNITOFMEASURE$0);
            }
