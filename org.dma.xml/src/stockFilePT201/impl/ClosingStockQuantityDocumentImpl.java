 ...
 */
public class ClosingStockQuantityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT201.ClosingStockQuantityDocument
{
    ...
    public stockFilePT201.SAFdecimalType xgetClosingStockQuantity()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT201.SAFdecimalType)get_store().find_element_user(CLOSINGSTOCKQUANTITY$0, 0);
            return target;
        }
    }
    ...
    public void xsetClosingStockQuantity(stockFilePT201.SAFdecimalType closingStockQuantity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT201.SAFdecimalType)get_store().add_element_user(CLOSINGSTOCKQUANTITY$0);
            }
