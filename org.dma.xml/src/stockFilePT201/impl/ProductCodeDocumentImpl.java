 ...
 */
public class ProductCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements stockFilePT201.ProductCodeDocument
{
    ...
    public stockFilePT201.SAFPTtextTypeMandatoryMax60Car xgetProductCode()
    {
        synchronized (monitor())
        {
            ...
            target = (stockFilePT201.SAFPTtextTypeMandatoryMax60Car)get_store().find_element_user(PRODUCTCODE$0, 0);
            return target;
        }
    }
    ...
    public void xsetProductCode(stockFilePT201.SAFPTtextTypeMandatoryMax60Car productCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (stockFilePT201.SAFPTtextTypeMandatoryMax60Car)get_store().add_element_user(PRODUCTCODE$0);
            }
