package pt.at.webservices.factemipf.proxy;
...
import pt.at.webservices.factemipf.client.Faturas;
import pt.at.webservices.factemipf.client.Faturas_Service;
import pt.at.webservices.factemipf.client.RegisterInvoiceResponseType;
...
/**
 * proxy para ligação ao endpoint do webservice.
 *
 * @author ricardo
 */
public class FaturasWSProxy {
     ...
     * Instancia a connecção, coloca os Handler (log e headers) e invoca o webservice
     *
     * @param registerInvoiceTypeRequest request Bean a ser utilizado na invocação do webservice
