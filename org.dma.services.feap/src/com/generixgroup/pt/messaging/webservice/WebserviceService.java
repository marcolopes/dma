 ...
 *
 */
@WebServiceClient(name = "WebserviceService", targetNamespace = "http://webservice.messaging.pt.generixgroup.com/", wsdlLocation = "file:wsdl/NetixMessaging-1.2.0.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:wsdl/NetixMessaging-1.2.0.wsdl");
