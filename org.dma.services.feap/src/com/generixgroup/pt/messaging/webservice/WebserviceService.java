 ...
 * 
 */
@WebServiceClient(name = "WebserviceService", targetNamespace = "http://webservice.messaging.pt.generixgroup.com/", wsdlLocation = "file:wsdl/InvoiceWebservice-1.2.0.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:wsdl/InvoiceWebservice-1.2.0.wsdl");
