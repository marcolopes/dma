...
public class ObjectFactory {
	...
	private final static QName _CheckVatApproxResponseTraderStreet_QNAME = new QName("urn:ec.europa.eu:taxud:vies:services:checkVat:types", "traderStreet");
	...
	private final static QName _CheckVatApproxResponseTraderPostcode_QNAME = new QName("urn:ec.europa.eu:taxud:vies:services:checkVat:types", "traderPostcode");
	private final static QName _CheckVatApproxResponseTraderAddress_QNAME = new QName("urn:ec.europa.eu:taxud:vies:services:checkVat:types", "traderAddress");
	...
	@XmlElementDecl(
		...
		name = "traderStreet", scope = CheckVatApproxResponse.class)
	public JAXBElement<String> createCheckVatApproxResponseTraderStreet(String value) {
		return new JAXBElement<String>(_CheckVatApproxResponseTraderStreet_QNAME, String.class, CheckVatApproxResponse.class, value);
	}
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "traderCompanyType", scope = CheckVatApproxResponse.class)
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "traderPostcode", scope = CheckVatApproxResponse.class)
	public JAXBElement<String> createCheckVatApproxResponseTraderPostcode(String value) {
		return new JAXBElement<String>(_CheckVatApproxResponseTraderPostcode_QNAME, String.class, CheckVatApproxResponse.class, value);
	}
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "traderAddress", scope = CheckVatApproxResponse.class)
	public JAXBElement<String> createCheckVatApproxResponseTraderAddress(String value) {
		return new JAXBElement<String>(_CheckVatApproxResponseTraderAddress_QNAME, String.class, CheckVatApproxResponse.class, value);
	}
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "traderName", scope = CheckVatApproxResponse.class)
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "name", scope = CheckVatResponse.class)
	...
	@XmlElementDecl(
		namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat:types",
		name = "address", scope = CheckVatResponse.class)
