 ...
 *         &lt;element name="WorkData" type="{http://factemi.at.min_financas.pt/documents}WorkDataType"/>
...
@XmlRootElement(name = "RegisterWorkRequest")
public class RegisterWorkRequest {
    ...
    @XmlElement(name = "WorkData", required = true)
    protected WorkDataType workData;
    ...
    /**
     * Gets the value of the workData property.
     * 
     * @return
     *     possible object is
     *     {@link WorkDataType }
     *     
     */
    public WorkDataType getWorkData() {
        return workData;
    }

    /**
     * Sets the value of the workData property.
     * 
     * @param value
     *     allowed object is
     *     {@link WorkDataType }
     *     
     */
    public void setWorkData(WorkDataType value) {
        this.workData = value;
    }
