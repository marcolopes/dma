...
import org.dma.services.at.AutenticationCypherUtil.Certificate;
...
public class SOAPMessageHandler implements SOAPHandler<SOAPMessageContext> {
	 ...
	 * @param saCertificate - Server Authentication Certificate
	...
	public Binding initializeBindings(WSBindingProvider bp, String endpoint, boolean secure) throws Exception {
		...
		if(secure){
			...
			kmf.init(swCertificate.keyStore, swCertificate.keyPassword.toCharArray());
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		try{
			...
			if(direction){
				...
				final PublicKey publicKey = saCertificate.keyStore.getCertificate(saCertificate.keyAlias).getPublicKey();
