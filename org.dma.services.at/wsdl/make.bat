...
wsimport faturas.wsdl -verbose -Xnocompile -s source
wsimport documentosTransporte.wsdl -verbose -Xnocompile -s source
wsimport eTaxFreeSoapWebServices.wsdl -verbose -Xnocompile -s source
